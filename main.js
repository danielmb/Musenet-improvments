// ==UserScript==
// @name         MuseNet imrpovements
// @namespace    http://tampermonkey.net/
// @version      0.1
// @description  try to take over the world!
// @author       You
// @match        https://openai.com/blog/musenet/
// @grant        none
// ==/UserScript==
...
let curInterval
function Run(){
    if (document.getElementById("forcebutton").innerText == "Force") {;

	let am=document.getElementsByClassName("mcc-comp-frag").length
	curInterval = setInterval(()=>{

	if (!document.getElementsByClassName("mcc-request-btn")[0].classList.contains("is-completion-pending")) {
		if (document.getElementsByClassName("mcc-comp-frag").length == am) {
            document.getElementById("forcebutton").innerText = "Stop";
            document.getElementsByClassName("mcc-request-btn")[0].click();
            document.getElementsByClassName("rc-slider-handle")[0].ariaValueNow = Math.round(Math.random() * (250 - 50 + 1) + 50) ;
            document.getElementsByClassName("mcc-slider-value")[0].innerText = document.getElementsByClassName("rc-slider-handle")[0].ariaValueNow;
		} else {
            console.log("Stopped")
            clearInterval(curInterval)
			new Audio("https://puu.sh/Gczp7/1d39736a93.mp3").play()
            document.getElementById("forcebutton").innerText = "Force";
...
document.getElementsByClassName("mcc-comp-view ")[0].insertAdjacentHTML("afterend", `<button id="forcebutton"> Force </button><input type="checkbox" id="spam">`);
document.getElementById("forcebutton").addEventListener("click", ()=>{Run()})

document.onkeypress = (evt)=>{if(evt.code == "Space" && evt.ctrlKey == "true" ) {
    clearInterval(curInterval)
}};
        },1000)
        ...
        var i = n(34)
          ...
          , d = function() {
            if (null != p)
                ...
                p;
            try {
                null == p && (window.AudioContext = window.AudioContext || window.webkitAudioContext,
                p = new AudioContext({}))
            } catch (e) {
                return null
            }
          ...
          , g = function(e, t) {
            ...
            for (var n = atob(e), i = n.length, r = Math.ceil(i / 1024), o = new Array(r), a = 0; a < r; ++a) {
                for (var s = 1024 * a, l = Math.min(s + 1024, i), u = new Array(l - s), c = s, p = 0; c < l; ++p,
                ++c)
                    u[p] = n[c].charCodeAt(0);
          ...
          , y = function(e, t) {
            var n = function(e) {
                var t = e
                  , n = [0, 0];
                return t.pageX || t.pageY ? (n[0] = t.pageX,
                n[1] = t.pageY) : t.clientX || t.clientY ? (n[0] = t.clientX + document.body.scrollLeft + document.documentElement.scrollLeft,
                n[1] = t.clientY + document.body.scrollTop + document.documentElement.scrollTop) : c.error("Unable to get mouse position from event."),
                n
            }(e)
              , i = [0, 0]
              , r = t.current;
            if (r.offsetParent)
                do {
                    r.classList.contains("full") || r.classList.contains("content") || (i[0] += r.offsetLeft,
                    i[1] += r.offsetTop)
                } while (r = r.offsetParent);return [n[0] - i[0], n[1] - i[1]]
        }
          , b = function(e, t) {
          ...
          , k = function(e, t) {
            ...
            var n = {
              ...
              , s = void 0;
            try {
                for (var l, c = u.d[Symbol.iterator](); !(o = (l = c.next()).done); o = !0) {
                    var p = l.value;
                    i[p] = null,
                    r[p] = null
                }
            ...
            var d = !0
              ...
              , h = void 0;
            try {
                for (var m, v = e.tracks[Symbol.iterator](); !(d = (m = v.next()).done); d = !0) {
                    var g = m.value;
                    i[g.instrument] = g
                }
            } catch (e) {
            ...
            var y = !0
              ...
              , w = void 0;
            try {
                for (var x, k = t.tracks[Symbol.iterator](); !(y = (x = k.next()).done); y = !0) {
                    var C = x.value;
                    r[C.instrument] = C
                }
            } catch (e) {
            ...
            var S = !0
              ...
              , T = void 0;
            try {
                for (var _, P = u.d[Symbol.iterator](); !(S = (_ = P.next()).done); S = !0) {
                    var O = _.value
                      , N = i[O]
                      , M = r[O]
                      , A = {
                    ...
                    if (N || M) {
                        if (N)
                            for (var D = 0; D < N.notes.length; D++)
                                A.notes.push(N.notes[D]);
                        if (M)
          ...
          , C = function(e, t, n, i, r) {
            ...
            t == n ? i : (a = r,
            s = (e - t) / (n - t),
            (o = i) + Math.max(Math.min(1, s), 0) * (a - o));
            var o, a, s
        }
    }
    ).call(this, n(101))
...
, function(e, t, n) {
    "use strict";
    t.__esModule = !0;
    var i, r = n(125), o = (i = r) && i.__esModule ? i : {
        default: i
    };
...
, function(e, t, n) {
    "use strict";
    t.__esModule = !0;
    var i, r = n(47), o = (i = r) && i.__esModule ? i : {
        default: i
    };
...
, function(e, t, n) {
    "use strict";
    t.__esModule = !0;
    var i, r = n(73), o = (i = r) && i.__esModule ? i : {
        default: i
    };
...
, function(e, t, n) {
    ...
    var i = n(7)
      ...
      , s = ["piano", "strings", "winds", "drums", "harp", "guitar", "bass"]
      , l = {
        piano: {
            color: "#5436da"
        },
...
, function(e, t, n) {
    var i = n(23)
      ...
      , s = n(27)
      , l = function(e, t, n) {
        var u, c, p, d = e & l.F, f = e & l.G, h = e & l.S, m = e & l.P, v = e & l.B, g = e & l.W, y = f ? r : r[t] || (r[t] = {}), b = y.prototype, w = f ? i : h ? i[t] : (i[t] || {}).prototype;
        for (u in f && (n = t),
        n)
            (c = !d && w && void 0 !== w[u]) && s(y, u) || (p = c ? w[u] : n[u],
            y[u] = f && "function" != typeof w[u] ? n[u] : v && c ? o(p, i) : g && w[u] == p ? function(e) {
...
, function(e, t, n) {
    var i, r;
    !function(o, a) {
        i = [n(41), n(67), n(21), n(105), n(106), n(107)],
            ...
            return function(e, t, n, i, r, o, a) {
                ...
                function f(e, t) {
                    ...
                    if (n) {
                        ...
                        u && u.error("Bad element for Flickity: " + (n || e))
                }
                f.defaults = {
                    accessibility: !0,
                    cellAlign: "center",
                    ...
                    this.cells.length) {
                        ...
                        this.cells.forEach(function(t, r) {
                            if (e.cells.length) {
                                ...
                                i.call(this, r, a) ? e.addCell(t) : (e.updateTarget(),
                                e = new o(this),
                                this.slides.push(e),
                                e.addCell(t))
                            } else
        ...
        i(t, [{
                ...
                if ("string" == typeof e)
                    for (var i = 0, r = t.length; i < r; i++)
                        if ("group" === t[i].type) {
                            ...
                            void 0 !== t[i].value && t[i].value === e && (n = t[i]);
                return n || e
            }
        }, {
            key: "setValue",
            ...
            value: function(e) {
                ...
                var i = e.label || e.value || e
                  ...
                  , a = (u(t = {}, this.props.baseClassName + "-option", !0),
            ...
            value: function(e) {
                this.mounted && (a.default.findDOMNode(this).contains(e.target) || this.state.isOpen && this.setState({
                    isOpen: !1
                }))
            }
        }, {
            ...
            key: "render",
            value: function() {
                var e, t, n, i, r, a = this.props, l = a.baseClassName, c = a.controlClassName, p = a.placeholderClassName, d = a.menuClassName, f = a.arrowClassName, h = a.arrowClosed, m = a.arrowOpen, v = a.className, g = this.props.disabled ? "Dropdown-disabled" : "", y = "string" == typeof this.state.selected ? this.state.selected : this.state.selected.label, b = (0,
                s.default)((u(e = {}, l + "-root", !0),
                u(e, v, !!v),
                u(e, "is-open", this.state.isOpen),
                e)), w = (0,
                s.default)((u(t = {}, l + "-control", !0),
                u(t, c, !!c),
                u(t, g, !!g),
                t)), x = (0,
                s.default)((u(n = {}, l + "-placeholder", !0),
                u(n, p, !!p),
                u(n, "is-selected", this.isValueSelected()),
                n)), k = (0,
                s.default)((u(i = {}, l + "-menu", !0),
                u(i, d, !!d),
                i)), C = (0,
                s.default)((u(r = {}, l + "-arrow", !0),
                u(r, f, !!f),
                r)), S = o.default.createElement("div", {
                    className: x
                }, y), E = this.state.isOpen ? o.default.createElement("div", {
                    className: k,
                    "aria-expanded": "true"
                }, this.buildMenu()) : null;
                return o.default.createElement("div", {
...
, function(e, t, n) {
    "use strict";
    t.__esModule = !0;
    var i, r = n(169), o = (i = r) && i.__esModule ? i : {
        default: i
    };
...
, function(e, t, n) {
    var i = n(31)
      ...
      , s = function() {}
      , l = function() {
        var e, t = n(69)("iframe"), i = o.length;
    ...
    void 0 === (r = "function" == typeof (i = function() {
        ...
        function s(t) {
            ...
            t && "object" == typeof t && t.nodeType) {
                ...
                var C = e(l.height);
                return !1 !== C && (u.height = C + (x ? 0 : v + w)),
                u.innerWidth = u.width - (m + b),
                u.innerHeight = u.height - (v + w),
...
, function(e, t, n) {
    ...
    e.exports = function(e, t, n, h, m, v, g) {
        ...
        }, k = t + " Iterator", C = "values" == m, S = !1, E = e.prototype, T = E[p] || E["@@iterator"] || m && E[m], _ = T || x(m), P = m ? C ? x("entries") : _ : void 0, O = "Array" == t && E.entries || T;
        if (O && (w = c(O.call(new e))) !== Object.prototype && w.next && (u(w, k, !0),
        i || "function" == typeof w[p] || a(w, p, f)),
        C && T && "values" !== T.name && (S = !0,
        _ = function() {
            return T.call(this)
        }
        ),
...
, function(e, t, n) {
    (function(n) {
        ...
        void 0 === (o = "function" == typeof (i = function() {
            ...
            : "download"in HTMLAnchorElement.prototype ? function(e, n, a) {
                ...
                l.origin === location.origin ? r(l) : i(l.href) ? t(e, n, a) : r(l, l.target = "_blank")) : (l.href = s.createObjectURL(e),
                setTimeout(function() {
    ...
    var d = function(e) {
        ...
        i(t, [{
            ...
            value: function(e, t) {
                ...
                s || !t.flickityReady && l ? (this.flkty.deactivate(),
                this.flkty.selectedIndex = a || 0,
                this.flkty.options.draggable = void 0 === o ? !!i && i.length > 1 : o,
                this.flkty.activate()) : this.flkty.reloadCells()
            }
        }, {
            key: "componentDidMount",
            value: function() {
            ...
            value: function() {
                ...
                return e ? (0,
                a.createPortal)(this.props.children, e) : void 0
            }
        }, {
            key: "render",
            value: function() {
...
, function(e, t, n) {
    ...
    ;
    var i, r = n(167), o = (i = r) && i.__esModule ? i : {
        default: i
    };
    e.exports = t.default
}
, function(e, t) {
    e.exports = function(e, t, n, i) {
        ...
        for (var s = Object.prototype.hasOwnProperty.bind(t), l = 0; l < o.length; l++) {
            ...
            var c = e[u]
              , p = t[u];
            if (!1 === (r = n ? n.call(i, c, p, u) : void 0) || void 0 === r && c !== p)
                return !1
        }
        return !0
    }
 ...
 */
    ...
    function y(e) {
        for (var t = arguments.length - 1, n = "https://reactjs.org/docs/error-decoder.html?invariant=" + e, i = 0; i < t; i++)
    ...
    function O(e, t, n) {
        ...
        if (null != t)
            ...
            t)
                _.call(t, i) && !P.hasOwnProperty(i) && (r[i] = t[i]);
    ...
    function R(e, t, n) {
        return null == e ? 0 : function e(t, n, i, r) {
            ...
            "function" == typeof c)
                for (t = c.call(t),
                u = 0; !(s = t.next()).done; )
                    l += e(s = s.value, c = n + F(s, u++), i, r);
            else
                "object" === s && y("31", "[object Object]" == (i = "" + t) ? "object with keys {" + Object.keys(t).join(", ") + "}" : i, "");
            return l
        }(e, "", t, n)
    }
    function F(e, t) {
    ...
    function I(e, t, n) {
        ...
        Array.isArray(e) ? U(e, i, n, function(e) {
            return e
        ...
        }(e, r + (!e.key || t && t.key === e.key ? "" : ("" + e.key).replace(M, "$&/") + "/") + n)),
        i.push(e))
    }
    ...
    var W = {
        Children: {
            map: function(e, t, n) {
                if (null == e)
                    return e;
                var i = [];
                return U(e, i, null, t, n),
                i
            },
            forEach: function(e, t, n) {
                if (null == e)
                    return e;
                R(e, j, t = D(null, null, t, n)),
                L(t)
            },
            count: function(e) {
                return R(e, function() {
        ...
        cloneElement: function(e, t, n) {
            ...
            if (null != t) {
                ...
                t)
                    _.call(t, r) && !P.hasOwnProperty(r) && (a[r] = void 0 === t[r] && void 0 !== c ? c[r] : t[r])
            }
 ...
 */
    ...
    function m() {
        if (f)
            for (var e in h) {
                ...
                if (-1 < n || a("96", e),
                !g[n])
                    for (var i in t.extractEvents || a("97", e),
                    g[n] = t,
                    n = t.eventTypes) {
                        var r = void 0
                          , o = n[i]
                        ...
                        if (u) {
                            for (r in u)
                                u.hasOwnProperty(r) && v(u[r], s, l);
                            r = !0
                        } else
                            o.registrationName ? (v(o.registrationName, s, l),
                            r = !0) : r = !1;
                        r || a("98", i, e)
                    }
            }
        ...
        injectEventPluginsByName: function(e) {
            ...
            for (t in e)
                if (e.hasOwnProperty(t)) {
                    var i = e[t];
                    h.hasOwnProperty(t) && h[t] === i || (h[t] && a("102", t),
                    h[t] = i,
                    n = !0)
                }
            n && m()
    ...
    function z(e, t, n) {
        (t = N(e, n.dispatchConfig.phasedRegistrationNames[t])) && (n._dispatchListeners = E(n._dispatchListeners, t),
    ...
    function V(e, t, n) {
        e && n && n.dispatchConfig.registrationName && (t = N(e, n.dispatchConfig.registrationName)) && (n._dispatchListeners = E(n._dispatchListeners, t),
        n._dispatchInstances = E(n._dispatchInstances, e))
    }
    function B(e) {
    ...
    function oe() {
        if (re)
            return re;
        var e, t, n = ie, i = n.length, r = "value"in ne ? ne.value : ne.textContent, o = r.length;
    ...
    function le(e, t, n, i) {
        ...
        return this.isDefaultPrevented = (null != n.defaultPrevented ? n.defaultPrevented : !1 === n.returnValue) ? ae : se,
    ...
    var Ee = {
        ...
        extractEvents: function(e, t, n, i) {
            ...
            if (me)
                ...
                Se ? ke(e, n) && (r = we.compositionEnd) : "keydown" === e && 229 === n.keyCode && (r = we.compositionStart);
            return r ? (ye && "ko" !== n.locale && (Se || r !== we.compositionStart ? r === we.compositionEnd && Se && (o = oe()) : (ie = "value"in (ne = i) ? ne.value : ne.textContent,
            Se = !0)),
            r = de.getPooled(r, t, n, i),
            o ? r.data = o : null !== (o = Ce(n)) && (r.data = o),
            H(r),
            o = r) : o = null,
            (e = ge ? function(e, t) {
                switch (e) {
                ...
                if (Se)
                    return "compositionend" === e || !me && ke(e, t) ? (e = oe(),
                    re = ie = ne = null,
                    Se = !1,
                    e) : null;
                switch (e) {
            ...
            }(e, n)) ? ((t = fe.getPooled(we.beforeInput, t, n, i)).data = e,
            H(t)) : t = null,
    ...
    function Be(e) {
        ...
        var n = t.getValue()
          , i = "";
        return e && (i = We(e) ? e.checked ? "true" : "false" : e.value),
        (e = i) !== n && (t.setValue(e),
        !0)
    }
    ...
    function lt(e) {
        ...
        do {
            ...
            default:
                ...
                i = o,
                o = "",
                r ? o = " (at " + r.fileName.replace(qe, "") + ":" + r.lineNumber + ")" : n && (o = " (created by " + n + ")"),
                n = "\n    in " + (i || "Unknown") + o
            }
            t += n,
            e = e.return
    ...
    function gt(e, t, n, i) {
        ...
        i || null === r ? function(e) {
            return !!ct.call(dt, e) || !ct.call(pt, e) && (ut.test(e) ? dt[e] = !0 : (pt[e] = !0,
            !1))
    ...
    var At = !1;
    function Dt() {
        _t && (_t.detachEvent("onpropertychange", Lt),
        Pt = _t = null)
    }
    function Lt(e) {
    ...
    function Rt(e, t, n) {
        "focus" === e ? (Dt(),
        Pt = n,
        (_t = t).attachEvent("onpropertychange", Lt)) : "blur" === e && Dt()
    }
    function Ft(e) {
    ...
    var Ut = {
        ...
        extractEvents: function(e, t, n, i) {
            ...
            if ("select" === s || "input" === s && "file" === r.type ? o = Mt : Ie(r) ? At ? o = It : (o = Ft,
            a = Rt) : (s = r.nodeName) && "input" === s.toLowerCase() && ("checkbox" === r.type || "radio" === r.type) && (o = jt),
            o && (o = o(e, t)))
                return Tt(o, n, i);
            a && a(e, r, t),
            "blur" === e && (e = r._wrapperState) && e.controlled && "number" === r.type && St(r, "number", r.value)
        }
    }
      , zt = le.extend({
        view: null,
    ...
    var Ht = 0
      ...
      , Qt = {
        ...
        extractEvents: function(e, t, n, i) {
            ...
            o ? (o = t,
            t = (t = n.relatedTarget || n.toElement) ? R(t) : null) : o = null,
            o === t)
                return null;
            var a = void 0
              , s = void 0
            ...
            s = $t.mouseLeave,
            l = $t.mouseEnter,
            u = "mouse") : "pointerout" !== e && "pointerover" !== e || (a = Kt,
            s = $t.pointerLeave,
            l = $t.pointerEnter,
            u = "pointer");
            var c = null == o ? r : j(o);
            ...
            o && i)
                ...
                t = null;
            for (r = t,
            t = []; o && o !== r && (null === (u = o.alternate) || u !== r); )
                t.push(o),
                o = U(o);
            for (o = []; i && i !== r && (null === (u = i.alternate) || u !== r); )
                o.push(i),
                i = U(i);
    ...
    function en(e, t) {
        ...
        for (i = 0; i < n.length; i++)
            if (!Jt.call(t, n[i]) || !Zt(e[n[i]], t[n[i]]))
                return !1;
        return !0
    }
    function tn(e) {
    ...
    var wn = {
        ...
        extractEvents: function(e, t, n, i) {
            ...
            return H(t = e.getPooled(r, t, n, i)),
            t
        }
    }
    ...
    function Cn(e) {
        ...
        do {
            ...
            for (i = n; i.return; )
                i = i.return;
            if (!(i = 3 !== i.tag ? null : i.stateNode.containerInfo))
                break;
            e.ancestors.push(n),
            n = R(i)
    ...
    function An(e) {
        return Object.prototype.hasOwnProperty.call(e, Mn) || (e[Mn] = Nn++,
        On[e[Mn]] = {}),
        On[e[Mn]]
    }
    function Dn(e) {
    ...
    var qn = {
        ...
        extractEvents: function(e, t, n, i) {
            ...
            if (r)
                return null;
            switch (o = t ? j(t) : window,
            e) {
            case "focus":
                (Ie(o) || "true" === o.contentEditable) && (zn = o,
                Wn = t,
                Vn = null);
                break;
            case "blur":
    ...
    var ti, ni = void 0, ii = (ti = function(e, t) {
    ...
    var oi = {
      ...
      , ai = ["Webkit", "ms", "Moz", "O"];
    function si(e, t, n) {
        return null == t || "boolean" == typeof t || "" === t ? "" : n || "number" != typeof t || 0 === t || oi.hasOwnProperty(e) && oi[e] ? ("" + t).trim() : t + "px"
    }
    function li(e, t) {
    ...
    function ci(e, t) {
        t && (ui[e] && (null != t.children || null != t.dangerouslySetInnerHTML) && a("137", e, ""),
    ...
    function Ii(e) {
        var t = e.stateNode;
        return t = t && t.__reactInternalMemoizedMergedChildContext || Pi,
        Mi = Oi.current,
        _i(Oi, t),
        _i(Ni, Ni.current),
        !0
    ...
    function Xi(e, t) {
        var n = e.alternate;
        return null === n ? ((n = Hi(e.tag, t, e.key, e.mode)).elementType = e.elementType,
        n.type = e.type,
    ...
    function Gi(e, t, n, i, r, o) {
        ...
        "function" == typeof e)
            ...
            case $e:
                return Ki(n, 2 | r, o, t);
            case Qe:
                return (e = Hi(12, n, t, 4 | r)).elementType = Qe,
                e.type = Qe,
                e.expirationTime = o,
                e;
            case nt:
                return (e = Hi(13, n, t, r)).elementType = nt,
                e.type = nt,
                e.expirationTime = o,
                e;
            default:
        ...
        return (t = Hi(s, n, t, r)).elementType = e,
        t.type = i,
        t.expirationTime = o,
        t
    }
    function Yi(e, t, n, i) {
        return (e = Hi(7, e, i, t)).expirationTime = n,
        e
    }
    function Ki(e, t, n, i) {
        return e = Hi(8, e, i, t),
    ...
    function $i(e, t, n) {
        return (e = Hi(6, e, null, t)).expirationTime = n,
        e
    }
    function Qi(e, t, n) {
        return (t = Hi(4, null !== e.children ? e.children : [], e.key, t)).expirationTime = n,
        t.stateNode = {
    ...
    function Ji(e, t) {
        ...
        0 === n ? e.earliestSuspendedTime = e.latestSuspendedTime = t : n < t ? e.earliestSuspendedTime = t : i > t && (e.latestSuspendedTime = t),
        tr(t, e)
    }
    function er(e, t) {
        var n = e.earliestPendingTime;
    ...
    function rr(e, t, n, i) {
        ...
        e.memoizedState = n,
        null !== (i = e.updateQueue) && 0 === e.expirationTime && (i.baseState = n)
    }
    var or = {
    ...
    function sr(e, t, n) {
        var i = !1
          , r = Pi
          , o = t.contextType;
        return "object" == typeof o && null !== o ? o = Wo(o) : (r = Di(t) ? Mi : Oi.current,
        o = (i = null != (i = t.contextTypes)) ? Ai(e, r) : Pi),
        t = new t(n,o),
    ...
    function ur(e, t, n, i) {
        ...
        r.refs = ir;
        var o = t.contextType;
        "object" == typeof o && null !== o ? r.context = Wo(o) : (o = Di(t) ? Mi : Oi.current,
        r.context = Ai(e, o)),
        null !== (o = e.updateQueue) && (ta(e, o, n, r, i),
        r.state = e.memoizedState),
        "function" == typeof (o = t.getDerivedStateFromProps) && (rr(e, t, o, n),
        r.state = e.memoizedState),
        ...
        t !== r.state && or.enqueueReplaceState(r, r.state, null),
        null !== (o = e.updateQueue) && (ta(e, o, n, r, i),
        r.state = e.memoizedState)),
    ...
    function fr(e) {
        ...
        function l(e, t, n, i) {
            return null === t || 6 !== t.tag ? ((t = $i(n, e.mode, i)).return = e,
            t) : ((t = r(t, n)).return = e,
            t)
        }
        function u(e, t, n, i) {
            return null !== t && t.elementType === n.type ? ((i = r(t, n.props)).ref = pr(e, t, n),
            i.return = e,
            i) : ((i = Gi(n.type, n.key, n.props, null, e.mode, i)).ref = pr(e, t, n),
            i.return = e,
            i)
        }
        function c(e, t, n, i) {
            return null === t || 4 !== t.tag || t.stateNode.containerInfo !== n.containerInfo || t.stateNode.implementation !== n.implementation ? ((t = Qi(n, e.mode, i)).return = e,
            t) : ((t = r(t, n.children || [])).return = e,
            t)
        }
        function p(e, t, n, i, o) {
            return null === t || 7 !== t.tag ? ((t = Yi(n, e.mode, i, o)).return = e,
            t) : ((t = r(t, n)).return = e,
            t)
        }
        function d(e, t, n) {
            if ("string" == typeof t || "number" == typeof t)
                return (t = $i("" + t, e.mode, n)).return = e,
                t;
            if ("object" == typeof t && null !== t) {
                switch (t.$$typeof) {
                case Ge:
                    return (n = Gi(t.type, t.key, t.props, null, e.mode, n)).ref = pr(e, null, t),
                    n.return = e,
                    n;
                case Ye:
                ...
                if (cr(t) || at(t))
                    return (t = Yi(t, e.mode, n, null)).return = e,
                    t;
                dr(e, t)
            }
            return null
        ...
        function h(e, t, n, i, r) {
            ...
            if ("object" == typeof i && null !== i) {
                ...
                case Ge:
                    ...
                    i.type === Ke ? p(t, e, i.props.children, r, i.key) : u(t, e, i, r);
                case Ye:
        ...
        function m(r, a, s, l) {
            ...
            if (null === p) {
                for (; m < s.length; m++)
                    (p = d(r, s[m], l)) && (a = o(p, a, m),
                    null === c ? u = p : c.sibling = p,
                    c = p);
                return u
            }
            for (p = i(r, p); m < s.length; m++)
                (v = h(p, r, m, s[m], l)) && (e && null !== v.alternate && p.delete(null === v.key ? m : v.key),
                a = o(v, a, m),
        ...
        function v(r, s, l, u) {
            ...
            for (var p = c = null, m = s, v = s = 0, g = null, y = l.next(); null !== m && !y.done; v++,
            y = l.next()) {
                m.index > v ? (g = m,
                m = null) : g = m.sibling;
            ...
            if (null === m) {
                for (; !y.done; v++,
                y = l.next())
                    null !== (y = d(r, y.value, u)) && (s = o(y, s, v),
                    null === p ? c = y : p.sibling = y,
                    p = y);
                return c
            }
            for (m = i(r, m); !y.done; v++,
            y = l.next())
                null !== (y = h(m, r, v, y.value, u)) && (e && null !== y.alternate && m.delete(null === y.key ? v : y.key),
                s = o(y, s, v),
                null === p ? c = y : p.sibling = y,
                p = y);
            ...
            if (c)
                ...
                case Ge:
                    e: {
                        ...
                        u = i; null !== u; ) {
                            if (u.key === c) {
                                if (7 === u.tag ? o.type === Ke : u.elementType === o.type) {
                                    n(e, u.sibling),
                                    (i = r(u, o.type === Ke ? o.props.children : o.props)).ref = pr(e, u, o),
                                    i.return = e,
                                    e = i;
                                    break e
                                }
                        ...
                        o.type === Ke ? ((i = Yi(o.props.children, e.mode, l, o.key)).return = e,
                        e = i) : ((l = Gi(o.type, o.key, o.props, null, e.mode, l)).ref = pr(e, i, o),
                        l.return = e,
                        e = l)
                    }
                    return s(e);
    ...
    function Kr(e, t, n, i, r, o) {
        if (Lr = o,
        Rr = t,
        jr = null !== e ? e.memoizedState : null,
        Dr.current = null === jr ? lo : uo,
        t = n(i, r),
        Hr) {
            do {
                Hr = !1,
        ...
        return Dr.current = so,
        (e = Rr).memoizedState = Ir,
        e.expirationTime = Wr,
        e.updateQueue = Vr,
        e.effectTag |= Br,
        e = null !== Fr && null !== Fr.next,
        Lr = 0,
        zr = Ur = Ir = jr = Fr = Rr = null,
        Wr = 0,
        Vr = null,
        Br = 0,
        e && a("300"),
    ...
    function Qr() {
        ...
        return null === Ur ? Ir = Ur = e : Ur = Ur.next = e,
        Ur
    }
    function Zr() {
        if (null !== zr)
            zr = (Ur = zr).next,
            jr = null !== (Fr = jr) ? Fr.next : null;
        else {
            null === jr && a("310");
            var e = {
                memoizedState: (Fr = jr).memoizedState,
                baseState: Fr.baseState,
                queue: Fr.queue,
                baseUpdate: Fr.baseUpdate,
                next: null
            };
            Ur = null === Ur ? Ir = e : Ur.next = e,
            jr = Fr.next
        }
        return Ur
    }
    ...
    function eo(e) {
            ...
            if (null !== qr) {
                ...
                if (void 0 !== r) {
                    ...
                    do {
                        o = e(o, r.action),
                        r = r.next
                    } while (null !== r);return Zt(o, t.memoizedState) || (xo = !0),
                    t.memoizedState = o,
        ...
        var s = t.baseUpdate;
        if (o = t.baseState,
        null !== s ? (null !== i && (i.next = null),
        i = s.next) : i = null !== i ? i.next : null,
        null !== i) {
            var l = r = null
              , u = i
              , c = !1;
            do {
                ...
                l = s,
                r = o),
                p > Wr && (Wr = p)) : o = u.eagerReducer === e ? u.eagerState : e(o, u.action),
                s = u,
                u = u.next
            } while (null !== u && u !== i);c || (l = s,
            r = o),
    ...
    function to(e, t, n, i) {
        ...
        null === Vr ? (Vr = {
            lastEffect: null
        }).lastEffect = e.next = e : null === (t = Vr.lastEffect) ? Vr.lastEffect = e.next = e : (n = t.next,
        t.next = e,
        e.next = n,
        Vr.lastEffect = e),
        e
    ...
    function no(e, t, n, i) {
        var r = Qr();
        Br |= e,
        r.memoizedState = to(t, n, void 0, void 0 === i ? null : i)
    }
    function io(e, t, n, i) {
        var r = Zr();
        i = void 0 === i ? null : i;
        ...
        if (null !== Fr) {
            ...
            if (o = a.destroy,
            null !== i && Yr(i, a.deps))
                return void to(Er, n, o, i)
        }
        Br |= e,
        r.memoizedState = to(t, n, o, i)
    }
    function ro(e, t) {
    ...
    function ao(e, t, n) {
        ...
        if (e === Rr || null !== i && i === Rr)
            ...
            if (t.last = o,
            0 === e.expirationTime && (null === i || 0 === i.expirationTime) && null !== (i = t.eagerReducer))
                try {
                    var u = t.eagerState
                      , c = i(u, n);
                    if (o.eagerReducer = i,
    ...
    var so = {
      ...
      , lo = {
        readContext: Wo,
        useCallback: function(e, t) {
            return Qr().memoizedState = [e, void 0 === t ? null : t],
            e
        },
        useContext: Wo,
        useEffect: function(e, t) {
        ...
        useImperativeHandle: function(e, t, n) {
            return n = null != n ? n.concat([e]) : [e],
            no(4, _r | Nr, ro.bind(null, t, e), n)
        },
        useLayoutEffect: function(e, t) {
      ...
      , uo = {
        ...
        useCallback: function(e, t) {
            ...
            return null !== i && null !== t && Yr(t, i[1]) ? i[0] : (n.memoizedState = [e, t],
            e)
        },
        useContext: Wo,
        useEffect: function(e, t) {
        ...
        useMemo: function(e, t) {
            ...
            t = void 0 === t ? null : t;
            var i = n.memoizedState;
            return null !== i && null !== t && Yr(t, i[1]) ? i[0] : (e = e(),
            n.memoizedState = [e, t],
            e)
        },
        useReducer: eo,
    ...
    function So(e, t, n, i, r, o) {
        if (null === e) {
            var a = n.type;
            return "function" != typeof a || qi(a) || void 0 !== a.defaultProps || null !== n.compare || void 0 !== n.defaultProps ? ((e = Gi(n.type, null, i, null, t.mode, o)).ref = t.ref,
            e.return = t,
            t.child = e) : (t.tag = 15,
            t.type = a,
            Eo(e, t, a, i, r, o))
        ...
        return a = e.child,
        r < o && (r = a.memoizedProps,
        (n = null !== (n = n.compare) ? n : en)(r, i) && e.ref === t.ref) ? Ao(e, t, o) : (t.effectTag |= 1,
        (e = Xi(a, i)).ref = t.ref,
        e.return = t,
        t.child = e)
    }
    function Eo(e, t, n, i, r, o) {
        return null !== e && en(e.memoizedProps, i) && e.ref === t.ref && (xo = !1,
        r < o) ? Ao(e, t, o) : _o(e, t, n, i, o)
    }
    function To(e, t) {
        var n = t.ref;
    ...
    function Po(e, t, n, i, r) {
        ...
        null === t.stateNode)
            ...
            p || "function" != typeof a.UNSAFE_componentWillReceiveProps && "function" != typeof a.componentWillReceiveProps || (s !== i || l !== u) && lr(t, a, i, u),
            Xo = !1;
            ...
            null !== f && (ta(t, f, i, a, r),
            l = t.memoizedState),
            s !== i || d !== l || Ni.current || Xo ? ("function" == typeof c && (rr(t, n, c, i),
            l = t.memoizedState),
            (s = Xo || ar(t, n, s, i, d, l, u)) ? (p || "function" != typeof a.UNSAFE_componentWillMount && "function" != typeof a.componentWillMount || ("function" == typeof a.componentWillMount && a.componentWillMount(),
            ...
            a.state = l,
            a.context = u,
            i = s) : ("function" == typeof a.componentDidMount && (t.effectTag |= 4),
            i = !1)
        } else
            a = t.stateNode,
            s = t.memoizedProps,
            a.props = t.type === t.elementType ? s : nr(t.type, s),
            l = a.context,
            "object" == typeof (u = n.contextType) && null !== u ? u = Wo(u) : u = Ai(t, u = Di(n) ? Mi : Oi.current),
            (p = "function" == typeof (c = n.getDerivedStateFromProps) || "function" == typeof a.getSnapshotBeforeUpdate) || "function" != typeof a.UNSAFE_componentWillReceiveProps && "function" != typeof a.componentWillReceiveProps || (s !== i || l !== u) && lr(t, a, i, u),
            Xo = !1,
            l = t.memoizedState,
            d = a.state = l,
            null !== (f = t.updateQueue) && (ta(t, f, i, a, r),
            d = t.memoizedState),
            s !== i || l !== d || Ni.current || Xo ? ("function" == typeof c && (rr(t, n, c, i),
            d = t.memoizedState),
            (c = Xo || ar(t, n, s, i, l, d, u)) ? (p || "function" != typeof a.UNSAFE_componentWillUpdate && "function" != typeof a.componentWillUpdate || ("function" == typeof a.componentWillUpdate && a.componentWillUpdate(i, d, u),
            "function" == typeof a.UNSAFE_componentWillUpdate && a.UNSAFE_componentWillUpdate(i, d, u)),
            "function" == typeof a.componentDidUpdate && (t.effectTag |= 4),
            "function" == typeof a.getSnapshotBeforeUpdate && (t.effectTag |= 256)) : ("function" != typeof a.componentDidUpdate || s === e.memoizedProps && l === e.memoizedState || (t.effectTag |= 4),
            ...
            a.state = d,
            a.context = u,
            i = c) : ("function" != typeof a.componentDidUpdate || s === e.memoizedProps && l === e.memoizedState || (t.effectTag |= 4),
            "function" != typeof a.getSnapshotBeforeUpdate || s === e.memoizedProps && l === e.memoizedState || (t.effectTag |= 256),
            i = !1);
    ...
    function Oo(e, t, n, i, r, o) {
        ...
        null !== e && a ? (t.child = hr(t, e.child, null, o),
        t.child = hr(t, null, s, o)) : ko(e, t, s, o),
    ...
    function Mo(e, t, n) {
        ...
        if (null === e)
            if (a) {
                ...
                n = i = mr(t, null, r.children, n);
        else
            null !== e.memoizedState ? (s = (i = e.child).sibling,
            a ? (n = r.fallback,
            r = Xi(i, i.pendingProps),
            0 == (1 & t.mode) && ((a = null !== t.memoizedState ? t.child.child : t.child) !== i.child && (r.child = a)),
            i = r.sibling = Xi(s, n, s.expirationTime),
            n = r,
            r.childExpirationTime = 0,
            n.return = i.return = t) : n = i = hr(t, i.child, r.children, n)) : (s = e.child,
            a ? (a = r.fallback,
            (r = Yi(null, i, 0, null)).child = s,
            0 == (1 & t.mode) && (r.child = null !== t.memoizedState ? t.child.child : t.child),
            (i = r.sibling = Yi(a, i, n, null)).effectTag |= 2,
            n = r,
            r.childExpirationTime = 0,
            n.return = i.return = t) : i = n = hr(t, s, r.children, n)),
    ...
    function Do(e, t, n) {
            ...
            if (e.memoizedProps !== t.pendingProps || Ni.current)
                ...
                case 13:
                    if (null !== t.memoizedState)
                        return 0 !== (i = t.child.childExpirationTime) && i >= n ? Mo(e, t, n) : null !== (t = Ao(e, t, n)) ? t.sibling : null
                }
                return Ao(e, t, n)
            }
        } else
        ...
        case 0:
            return i = t.type,
            r = t.pendingProps,
            _o(e, t, i, r = t.elementType === i ? r : nr(i, r), n);
        case 1:
            return i = t.type,
            r = t.pendingProps,
            Po(e, t, i, r = t.elementType === i ? r : nr(i, r), n);
        case 3:
            return No(t),
            null === (i = t.updateQueue) && a("282"),
            r = null !== (r = t.memoizedState) ? r.element : null,
            ta(t, i, t.pendingProps, null, n),
            (i = t.memoizedState.element) === r ? (bo(),
            t = Ao(e, t, n)) : (r = t.stateNode,
            (r = (null === e || null === e.child) && r.hydrate) && (po = Ci(t.stateNode.containerInfo),
            co = t,
            r = fo = !0),
            r ? (t.effectTag |= 2,
            t.child = mr(t, null, i, n)) : (ko(e, t, i, n),
            bo()),
            t = t.child),
            t;
        case 5:
            ...
            s = r.children,
            gi(i, r) ? s = null : null !== o && gi(i, o) && (t.effectTag |= 16),
            To(e, t),
            1 !== n && 1 & t.mode && r.hidden ? (t.expirationTime = t.childExpirationTime = 1,
            t = null) : (ko(e, t, s, n),
            t = t.child),
            t;
        case 6:
        ...
        case 13:
            return Mo(e, t, n);
        case 4:
            return xr(t, t.stateNode.containerInfo),
            i = t.pendingProps,
            null === e ? t.child = hr(t, null, i, n) : ko(e, t, i, n),
            t.child;
        case 11:
            return i = t.type,
            r = t.pendingProps,
            Co(e, t, i, r = t.elementType === i ? r : nr(i, r), n);
        case 7:
        ...
        case 9:
            ...
            t.child;
        case 14:
            return o = nr(r = t.type, t.pendingProps),
            So(e, t, r, o = nr(r.type, o), i, n);
        case 15:
            return Eo(e, t, t.type, t.pendingProps, i, n);
        case 17:
            return i = t.type,
            r = t.pendingProps,
            r = t.elementType === i ? r : nr(i, r),
            null !== e && (e.alternate = null,
            t.alternate = null,
            t.effectTag |= 2),
            t.tag = 1,
    ...
    function Wo(e, t) {
        return jo !== e && !1 !== t && 0 !== t && ("number" == typeof t && 1073741823 !== t || (jo = e,
        t = 1073741823),
        t = {
            context: e,
            observedBits: t,
        ...
        null === Fo ? (null === Ro && a("308"),
        Fo = t,
        Ro.contextDependencies = {
            first: t,
            expirationTime: 0
        }) : Fo = Fo.next = t),
        e._currentValue
    ...
    function Qo(e, t) {
        ...
        if (null === n) {
            ...
            i = e.updateQueue,
            r = n.updateQueue,
            null === i ? null === r ? (i = e.updateQueue = Go(e.memoizedState),
            r = n.updateQueue = Go(n.memoizedState)) : i = e.updateQueue = Yo(r) : null === r && (r = n.updateQueue = Yo(i));
        null === r || i === r ? $o(i, t) : null === i.lastUpdate || null === r.lastUpdate ? ($o(i, t),
        $o(r, t)) : ($o(i, t),
        r.lastUpdate = t)
    }
    function Zo(e, t) {
        var n = e.updateQueue;
        null === (n = null === n ? e.updateQueue = Go(e.memoizedState) : Jo(e, n)).lastCapturedUpdate ? n.firstCapturedUpdate = n.lastCapturedUpdate = t : (n.lastCapturedUpdate.next = t,
    ...
    function ea(e, t, n, i, o, a) {
        ...
        case Vo:
            if (null == (o = "function" == typeof (e = n.payload) ? e.call(a, i, o) : e))
                break;
            return r({}, i, o);
        case Ho:
            Xo = !0
    ...
    function ta(e, t, n, i, r) {
        Xo = !1;
        for (var o = (t = Jo(e, t)).baseState, a = null, s = 0, l = t.firstUpdate, u = o; null !== l; ) {
            var c = l.expirationTime;
            c < r ? (null === a && (a = l,
            o = u),
            s < c && (s = c)) : (u = ea(e, 0, l, u, n, i),
    ...
    sa = function() {}
    ,
    la = function(e, t, n, i, o) {
        var a = e.memoizedProps;
        if (a !== i) {
            var s = t.stateNode;
            switch (wr(gr.current),
            e = null,
            n) {
            case "input":
                a = bt(s, a),
            ...
            for (n in i) {
                var c = i[n];
                if (u = null != a ? a[n] : void 0,
                i.hasOwnProperty(n) && c !== u && (null != c || null != u))
                    if ("style" === n)
                        if (u) {
                            for (s in u)
                                !u.hasOwnProperty(s) || c && c.hasOwnProperty(s) || (l || (l = {}),
                                l[s] = "");
                            for (s in c)
                                c.hasOwnProperty(s) && u[s] !== c[s] && (l || (l = {}),
                                l[s] = c[s])
                        } else
                            l || (e || (e = []),
                            e.push(n, l)),
                        ...
                        u = u ? u.__html : void 0,
                        null != c && u !== c && (e = e || []).push(n, "" + c)) : "children" === n ? u === c || "string" != typeof c && "number" != typeof c || (e = e || []).push(n, "" + c) : "suppressContentEditableWarning" !== n && "suppressHydrationWarning" !== n && (b.hasOwnProperty(n) ? (null != c && di(o, n),
    ...
    function ha(e) {
        switch ("function" == typeof Wi && Wi(e),
        e.tag) {
        case 0:
        case 11:
        case 14:
        ...
        for (var r = e; ; ) {
            if (5 === r.tag || 6 === r.tag)
                if (n)
                    ...
                    i ? (s = t,
                    l = r.stateNode,
                    8 === s.nodeType ? (o = s.parentNode).insertBefore(l, s) : (o = s).appendChild(l),
                    null != (s = s._reactRootContainer) || null !== o.onclick || (o.onclick = fi)) : t.appendChild(r.stateNode);
    ...
    function ga(e) {
        for (var t = e, n = !1, i = void 0, r = void 0; ; ) {
            ...
            if (5 === t.tag || 6 === t.tag) {
                ...
                r ? (o = i,
                s = t.stateNode,
                8 === o.nodeType ? o.parentNode.removeChild(s) : o.removeChild(s)) : i.removeChild(t.stateNode)
            } else if (4 === t.tag ? (i = t.stateNode.containerInfo,
            r = !0) : ha(t),
            null !== t.child) {
                t.child.return = t,
                t = t.child;
    ...
    function ya(e, t) {
        ...
        case 5:
            ...
            if (null != n) {
                ...
                var r = t.type
                  , o = t.updateQueue;
                t.updateQueue = null,
                null !== o && function(e, t, n, i, r) {
                    e[L] = r,
                    "input" === n && "radio" === r.type && null != r.name && xt(e, r),
                    pi(n, i),
                    i = pi(n, r);
                    ...
                    case "select":
                        ...
                        null != (n = r.value) ? Gn(e, !!r.multiple, n, !1) : t !== !!r.multiple && (null != r.defaultValue ? Gn(e, !!r.multiple, r.defaultValue, !0) : Gn(e, !!r.multiple, r.multiple ? [] : "", !1))
                    }
                }(n, o, r, e, i)
            }
            break;
        ...
        case 13:
            ...
            null === n ? i = !1 : (i = !0,
            e = t.child,
            0 === n.timedOutAt && (n.timedOutAt = bs())),
            null !== e && function(e, t) {
                for (var n = e; ; ) {
                    if (5 === n.tag) {
                        var i = n.stateNode;
            ...
            null !== (n = t.updateQueue)) {
                t.updateQueue = null;
                var s = t.stateNode;
                null === s && (s = t.stateNode = new ca),
                n.forEach(function(e) {
                    var n = function(e, t) {
                        var n = e.stateNode;
                        null !== n && n.delete(t),
                        t = qa(t = bs(), e),
                        null !== (e = Ga(e, t)) && (Zi(e, t),
                        0 !== (t = e.expirationTime) && ws(e, t))
                    }
                    .bind(null, t, e);
                    s.has(e) || (s.add(e),
                    e.then(n, n))
            ...
            if (0 == (1024 & e.effectTag)) {
                ...
                e: {
                    ...
                    case 5:
                        ...
                        null !== o && null != t.stateNode)
                            ...
                            if (yo(t)) {
                                ...
                                p = null,
                                d)
                                    d.hasOwnProperty(s) && (c = d[s],
                                    "children" === s ? "string" == typeof c ? o.textContent !== c && (p = ["children", c]) : "number" == typeof c && o.textContent !== "" + c && (p = ["children", "" + c]) : b.hasOwnProperty(s) && null != c && di(f, s));
                                switch (u) {
                                case "input":
                                    Ve(o),
                                    Ct(o, d, !0);
                                ...
                                c === Zn.html && (c = Jn(o)),
                                c === Zn.html ? "script" === o ? ((o = p.createElement("div")).innerHTML = "<script><\/script>",
                                p = o.removeChild(o.firstChild)) : "string" == typeof f.is ? p = p.createElement(o, {
                                    is: f.is
                                }) : (p = p.createElement(o),
                                "select" === o && f.multiple && (p.multiple = !0)) : p = p.createElementNS(c, o),
                                (o = p)[D] = d,
                                o[L] = l,
                                aa(o, t, !1, !1),
                                f = o;
                                ...
                                case "select":
                                    ...
                                    null != (f = d.value) ? Gn(u, !!d.multiple, f, !1) : null != d.defaultValue && Gn(u, !!d.multiple, d.defaultValue, !0);
                                    break;
                                default:
                        ...
                        break;
                    case 6:
                        o && null != t.stateNode ? ua(o, t, o.memoizedProps, l) : ("string" != typeof l && (null === t.stateNode && a("166")),
                        o = wr(br.current),
                        wr(gr.current),
                        yo(t) ? (s = (l = t).stateNode,
                        o = l.memoizedProps,
                        s[D] = l,
                        (l = s.nodeValue !== o) && oa(t)) : (s = t,
                        (l = (9 === o.nodeType ? o : o.ownerDocument).createTextNode(l))[D] = t,
                        s.stateNode = l));
                        break;
                    case 11:
                        break;
                    case 13:
                        ...
                        null !== o && !l && s && (null !== (o = o.child.sibling) && (null !== (u = t.firstEffect) ? (t.firstEffect = o,
                ...
                if (t = e,
                1 === Na || 1 !== t.childExpirationTime) {
                    for (l = 0,
                    s = t.child; null !== s; )
                        (o = s.expirationTime) > l && (l = o),
    ...
    function Ba(e, t) {
        ...
        i === Na && e === Oa && null !== Pa || (Ua(),
        Na = i,
        Pa = Xi((Oa = e).current, null),
                    ...
                    if (null !== s) {
                        e: {
                            ...
                            null !== p && "object" == typeof p && "function" == typeof p.then) {
                                ...
                                do {
                                    if ((m = 13 === p.tag) && (m = void 0 !== p.memoizedProps.fallback && null === p.memoizedState),
                                    m) {
                                        if (null === (u = p.updateQueue) ? ((u = new Set).add(d),
                                        p.updateQueue = u) : u.add(d),
                                        0 == (1 & p.mode)) {
                                            p.effectTag |= 64,
                                            c.effectTag &= -1957,
                                            1 === c.tag && (null === c.alternate ? c.tag = 17 : ((s = Ko(1073741823)).tag = Ho,
                                            Qo(c, s))),
                                            c.expirationTime = 1073741823;
                                            break e
                                        }
                                        null === (c = l.pingCache) ? (c = l.pingCache = new ba,
                                        u = new Set,
                                        c.set(d, u)) : void 0 === (u = c.get(d)) && (u = new Set,
                                        c.set(d, u)),
                                        u.has(s) || (u.add(s),
                                        c = Xa.bind(null, l, d, s),
                                        d.then(c, c)),
                                        -1 === f ? l = 1073741823 : (-1 === h && (h = 10 * (1073741822 - er(l, s)) - 5e3),
                                        l = h + f),
                                        0 <= l && Ma < l && (Ma = l),
                                        p.effectTag |= 2048,
                                        p.expirationTime = s;
                            ...
                            do {
                                ...
                                case 1:
                                    ...
                                    f = l.type,
                                    h = l.stateNode,
                                    0 == (64 & l.effectTag) && ("function" == typeof f.getDerivedStateFromError || null !== h && "function" == typeof h.componentDidCatch && (null === Ia || !Ia.has(h)))) {
                                        l.effectTag |= 2048,
                                        l.expirationTime = s,
                                        Zo(l, s = xa(l, d, s));
                                        break e
        ...
        r)
            ...
            Aa) {
                ...
                0 !== r && r < i || 0 !== o && o < i || 0 !== s && s < i)
                    return Ji(e, i),
                    void ys(e, n, i, e.expirationTime, -1);
                if (!e.didError && t)
                    return e.didError = !0,
            ...
            t && -1 !== Ma ? (Ji(e, i),
            (t = 10 * (1073741822 - er(e, i))) < Ma && (Ma = t),
            t = 10 * (1073741822 - bs()),
            t = Ma - t,
            ys(e, n, i, e.expirationTime, 0 > t ? 0 : t)) : (e.pendingCommitExpirationTime = i,
            e.finishedWork = n)
        }
    }
    function Ha(e, t) {
        for (var n = e.return; null !== n; ) {
            ...
            case 1:
                var i = n.stateNode;
                if ("function" == typeof n.type.getDerivedStateFromError || "function" == typeof i.componentDidCatch && (null === Ia || !Ia.has(i)))
                    return Qo(n, e = xa(n, e = ra(t, e), 1073741823)),
                    void Ya(n, 1073741823);
                break;
            case 3:
                return Qo(n, e = wa(n, e = ra(t, e), 1073741823)),
                void Ya(n, 1073741823)
            }
            n = n.return
        }
        3 === e.tag && (Qo(e, n = wa(e, n = ra(t, e), 1073741823)),
        Ya(e, 1073741823))
    }
    function qa(e, t) {
        return 0 !== Ta ? e = Ta : _a ? e = La ? 1073741823 : Na : 1 & t.mode ? (e = ls ? 1073741822 - 10 * (1 + ((1073741822 - e + 15) / 10 | 0)) : 1073741822 - 25 * (1 + ((1073741822 - e + 500) / 25 | 0)),
        null !== Oa && e === Na && --e) : e = 1073741823,
        ls && (0 === is || e < is) && (is = e),
        e
    }
    function Xa(e, t, n) {
        var i = e.pingCache;
        null !== i && i.delete(t),
        null !== Oa && Na === n ? Oa = null : (t = e.earliestSuspendedTime,
        i = e.latestSuspendedTime,
        0 !== t && n <= t && n >= i && (e.didError = !1,
        (0 === (t = e.latestPingedTime) || t > n) && (e.latestPingedTime = n),
        tr(n, e),
        0 !== (n = e.expirationTime) && ws(e, n)))
    }
    function Ga(e, t) {
    ...
    function Ya(e, t) {
        null !== (e = Ga(e, t)) && (!_a && 0 !== Na && t > Na && Ua(),
        Zi(e, t),
        _a && !La && Oa === e || ws(e, e.expirationTime),
        hs > fs && (hs = 0,
        a("185")))
    }
    ...
    function gs(e, t) {
        ...
        Za = t,
        e = o.unstable_now() - cs,
        Ja = o.unstable_scheduleCallback(Ss, {
            timeout: 10 * (1073741822 - t) - e
        })
    }
    function ys(e, t, n, i, r) {
        e.expirationTime = i,
        0 !== r || Cs() ? 0 < r && (e.timeoutHandle = yi(function(e, t, n) {
        ...
        .bind(null, e, t, n), r)) : (e.pendingCommitExpirationTime = n,
        e.finishedWork = t)
    }
    function bs() {
        return es ? ds : (xs(),
    ...
    function ws(e, t) {
        ...
        null === Qa ? ($a = Qa = e,
        e.nextScheduledRoot = e) : (Qa = Qa.nextScheduledRoot = e).nextScheduledRoot = $a) : t > e.expirationTime && (e.expirationTime = t),
        es || (as ? ss && (ts = e,
        ns = 1073741823,
        _s(e, 1073741823, !1)) : 1073741823 === t ? Es(1073741823, !1) : gs(e, t))
    }
    function xs() {
        var e = 0
          , t = null;
        ...
        try {
            if (!Cs() && null !== $a) {
                ...
                do {
                    ...
                    0 !== t && ps <= t && (e.nextExpirationTimeToWorkOn = ps),
    ...
    function Es(e, t) {
        ...
        t)
            for (vs(),
            ds = ps; null !== ts && 0 !== ns && e <= ns && !(ks && ps > ns); )
                _s(ts, ns, ps > ns),
                xs(),
                vs(),
                ds = ps;
        else
            for (; null !== ts && 0 !== ns && e <= ns; )
                _s(ts, ns, !1),
                xs();
        if (t && (Za = 0,
        Ja = null),
    ...
    function _s(e, t, n) {
        ...
        n) {
            ...
            null !== i ? Ps(e, i, t) : (e.finishedWork = null,
            -1 !== (i = e.timeoutHandle) && (e.timeoutHandle = -1,
            bi(i)),
            Ba(e, n),
            null !== (i = e.finishedWork) && (Cs() ? e.finishedWork = i : Ps(e, i, t)))
        } else
            null !== (i = e.finishedWork) ? Ps(e, i, t) : (e.finishedWork = null,
            -1 !== (i = e.timeoutHandle) && (e.timeoutHandle = -1,
            bi(i)),
            Ba(e, n),
            null !== (i = e.finishedWork) && Ps(e, i, t));
        es = !1
    }
    function Ps(e, t, n) {
        var i = e.firstBatch;
        if (null !== i && i._expirationTime >= n && (null === us ? us = [i] : us.push(i),
        i._defer))
        ...
        if (i = r > i ? r : i,
        e.didError = !1,
        0 === i ? (e.earliestPendingTime = 0,
        e.latestPendingTime = 0,
        e.earliestSuspendedTime = 0,
        e.latestSuspendedTime = 0,
        e.latestPingedTime = 0) : (i < e.latestPingedTime && (e.latestPingedTime = 0),
        0 !== (r = e.latestPendingTime) && (r > i ? e.earliestPendingTime = e.latestPendingTime = 0 : e.earliestPendingTime > i && (e.earliestPendingTime = e.latestPendingTime)),
        0 === (r = e.earliestSuspendedTime) ? Zi(e, i) : i < e.latestSuspendedTime ? (e.earliestSuspendedTime = 0,
        e.latestSuspendedTime = 0,
        ...
        i = t.firstEffect) : i = t : i = t.firstEffect,
        hi = Sn,
        jn(r = Fn())) {
            if ("selectionStart"in r)
                ...
                e: {
                    var s = (o = (o = r.ownerDocument) && o.defaultView || window).getSelection && o.getSelection();
                    if (s && 0 !== s.rangeCount) {
                        o = s.anchorNode;
                        ...
                        var c = 0
                          ...
                          , v = null;
                        t: for (; ; ) {
                            for (var g; m !== o || 0 !== l && 3 !== m.nodeType || (p = c + l),
        ...
        C = E.focusedElem,
        y = E.selectionRange,
        S !== C && C && C.ownerDocument && function e(t, n) {
            return !(!t || !n) && (t === n || (!t || 3 !== t.nodeType) && (n && 3 === n.nodeType ? e(t, n.parentNode) : "contains"in t ? t.contains(n) : !!t.compareDocumentPosition && !!(16 & t.compareDocumentPosition(n))))
        }(C.ownerDocument.documentElement, C)) {
            null !== y && jn(C) && (S = y.start,
            void 0 === (E = y.end) && (E = S),
            "selectionStart"in C ? (C.selectionStart = S,
            C.selectionEnd = Math.min(E, C.value.length)) : (E = (S = C.ownerDocument || document) && S.defaultView || window).getSelection && (E = E.getSelection(),
            ...
            b = Rn(C, T),
            w = Rn(C, y),
            b && w && (1 !== E.rangeCount || E.anchorNode !== b.node || E.anchorOffset !== b.offset || E.focusNode !== w.node || E.focusOffset !== w.offset) && ((S = S.createRange()).setStart(b.node, b.offset),
            E.removeAllRanges(),
            T > y ? (E.addRange(S),
            E.extend(w.node, w.offset)) : (S.setEnd(w.node, w.offset),
            E.addRange(S))))),
            S = [];
            ...
            C = 0; C < S.length; C++)
                (E = S[C]).element.scrollLeft = E.left,
        ...
        _ = t.expirationTime,
        0 === (t = (t = t.childExpirationTime) > _ ? t : _) && (Ia = null),
        e.expirationTime = t,
        e.finishedWork = null
    }
    function Os(e) {
    ...
    Fs.prototype.render = function(e) {
        ...
        var t = this._root._internalRoot
          ...
          , i = new js;
        return Ds(e, t, null, n, i._onCommit),
        i
    }
    ,
    ...
    var Vs = {
        ...
        unmountComponentAtNode: function(e) {
            return Us(e) || a("40"),
            !!e._reactRootContainer && (Ms(function() {
        ...
        unstable_createRoot: function(e, t) {
            return Us(e) || a("299", "unstable_createRoot"),
            new Is(e,!0,null != t && !0 === t.hydrate)
        },
 ...
 */
            ...
            if ("function" == typeof l)
                ...
                null === n)
                    ...
                    do {
                        ...
                        e = e.next
                    } while (e !== n);null === i ? i = n : i === n && (n = l,
                    u()),
                    (t = i.previous).next = i.previous = l,
                    l.next = i,
                    l.previous = t
                }
        }
        ...
        var f, h, m = Date, v = "function" == typeof setTimeout ? setTimeout : void 0, g = "function" == typeof clearTimeout ? clearTimeout : void 0, y = "function" == typeof requestAnimationFrame ? requestAnimationFrame : void 0, b = "function" == typeof cancelAnimationFrame ? cancelAnimationFrame : void 0;
        function w(e) {
            f = y(function(t) {
                g(h),
                e(t)
        ...
        E && E._schedMock) {
            ...
            k = function(e, t) {
                O = e,
                M = t,
                D || 0 > t ? I.postMessage(void 0) : A || (A = !0,
                w(U))
            }
            ,
            C = function() {
        ...
        t.unstable_scheduleCallback = function(e, i) {
            ...
            if ("object" == typeof i && null !== i && "number" == typeof i.timeout)
                i = a + i.timeout;
            else
                switch (r) {
                case 1:
            ...
            null === n)
                ...
                do {
                    ...
                    s = s.next
                } while (s !== n);null === a ? a = n : a === n && (n = e,
                u()),
                (i = a.previous).next = a.previous = e,
                e.next = a,
                e.previous = i
            }
            return e
...
, function(e, t, n) {
    var i = function(e) {
        "use strict";
        var t, n = Object.prototype, i = n.hasOwnProperty, r = "function" == typeof Symbol ? Symbol : {}, o = r.iterator || "@@iterator", a = r.asyncIterator || "@@asyncIterator", s = r.toStringTag || "@@toStringTag";
        function l(e, t, n, i) {
        ...
        return v.prototype = x.constructor = g,
        g.constructor = v,
 ...
 */
    window,
    r = [n(25), n(108), n(110), n(111), n(112), n(113), n(114)],
            ...
            return function(e, t, n, i) {
                ...
                r.pointerDown = function(t, n) {
                    if (this.isDraggable) {
                        ...
                        i && (this._pointerDownPreventDefault(t),
    ...
    void 0 === (r = function(e, t, n) {
        return function(e, t, n, i) {
            ...
            o.prototype.createSVG = function() {
                ...
                var t, n = document.createElementNS(r, "path"), i = "string" == typeof (t = this.parent.options.arrowShape) ? t : "M " + t.x0 + ",50 L " + t.x1 + "," + (t.y1 + 50) + " L " + t.x2 + "," + (t.y2 + 50) + " L " + t.x3 + ",50  L " + t.x2 + "," + (50 - t.y2) + " L " + t.x1 + "," + (50 - t.y1) + " Z";
        ...
        return function(e, t, n) {
            ...
            i.prototype.play = function() {
                if ("playing" != this.state) {
                    ...
                    e ? document.addEventListener("visibilitychange", this.onVisibilityPlay) : (this.state = "playing",
...
, function(e, t, n) {
    ...
    e.exports = function(e) {
        ...
        var t = (i.cssRules || i.rules).length;
        return i.insertRule(e, t),
        i
    }
}
, function(e, t, n) {
...
, function(e, t, n) {
    ...
    : function(e) {
      ...
      , G = function(e, t, n) {
        ...
        t = x(t, !0),
        y(n),
        r(I, t) ? (n.enumerable ? (r(e, L) && e[L][t] && (e[L][t] = !1),
        n = C(n, {
            enumerable: k(0, !1)
        })) : (r(e, L) || O(e, L, k(1, {})),
        e[L][t] = !0),
      ...
      , $ = function(e, t) {
        ...
        e !== z || !r(I, t) || r(U, t)) {
            var n = P(e, t);
            return !n || !r(I, t) || r(e, L) && e[L][t] || (n.enumerable = !0),
            n
        }
    }
      , Q = function(e) {
        for (var t, n = N(w(e)), i = [], o = 0; n.length > o; )
            r(I, t = n[o++]) || t == L || t == l || i.push(t);
        return i
    }
      , Z = function(e) {
        for (var t, n = e === z, i = N(n ? U : w(e)), o = [], a = 0; i.length > a; )
            !r(I, t = i[a++]) || n && !r(z, t) || o.push(I[t]);
        return o
    };
    W || (s((M = function() {
    ...
    n(45).f = K,
    n(60).f = Z,
    o && !n(43) && s(z, "propertyIsEnumerable", K, !0),
    h.f = function(e) {
        return q(f(e))
    }
    ),
    ...
    for (var J = "hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables".split(","), ee = 0; J.length > ee; )
        f(J[ee++]);
    for (var te = _(f.store), ne = 0; te.length > ne; )
        m(te[ne++]);
    a(a.S + a.F * !W, "Symbol", {
        for: function(e) {
    ...
    M.prototype[R] || n(30)(M.prototype, R, M.prototype.valueOf),
    p(M, "Symbol"),
    p(Math, "Math", !0),
    p(i.JSON, "JSON", !0)
}
...
, function(e, t, n) {
    ...
    e.exports = {
        set: Object.setPrototypeOf || ("__proto__"in {} ? function(e, t, i) {
            try {
                (i = n(52)(Function.call, n(65).f(Object.prototype, "__proto__").set, 2))(e, []),
...
, function(e, t, n) {
    ...
    var c = [{
        ...
        fix: function(e, t) {
            ...
            o && (r = o / 120),
            u && (r = 0 - (u % 3 == 0 ? u / 3 : u)),
            void 0 !== a && (a === e.HORIZONTAL_AXIS ? (i = 0,
            n = 0 - r) : a === e.VERTICAL_AXIS && (n = 0,
            i = r)),
            void 0 !== s && (i = s / 120),
            void 0 !== l && (n = -1 * l / 120),
            n || i || (i = r),
        ...
        fix: function(e, t) {
            var n = void 0
              ...
              , o = e.target
              , a = t.button;
            return o && u(e.pageX) && !u(t.clientX) && (i = (n = o.ownerDocument || document).documentElement,
            r = n.body,
    ...
    function f(e) {
        ...
        this.nativeEvent = e;
        var i = d;
        "defaultPrevented"in e ? i = e.defaultPrevented ? p : d : "getPreventDefault"in e ? i = e.getPreventDefault() ? p : d : "returnValue"in e && (i = e.returnValue === s ? p : d),
        ...
        for (c.forEach(function(e) {
            t.match(e.reg) && (f = f.concat(e.props),
            e.fix && o.push(e.fix))
        }),
        a = f.length; a; )
            this[u = f[--a]] = e[u];
...
, function(e, t, n) {
    ...
    r(r.S + r.F * !n(177)(function(e) {
        ...
        from: function(e) {
            var t, n, r, p, d = o(e), f = "function" == typeof this ? this : Array, h = arguments.length, m = h > 1 ? arguments[1] : void 0, v = void 0 !== m, g = 0, y = c(d);
            if (v && (m = i(m, h > 2 ? arguments[2] : void 0, 2)),
            null == y || f == Array && s(y))
                for (n = new f(t = l(d.length)); t > g; g++)
                    u(n, g, v ? m(d[g], g) : d[g]);
            else
                for (p = y.call(d),
                n = new f; !(r = p.next()).done; g++)
                    u(n, g, v ? a(p, m, [r.value, g], !0) : r.value);
            return n.length = g,
            n
        }
    })
...
, function(e, t, n) {
    ...
    var a = function(e) {
        ...
        function i(e, t, n, o) {
            ...
            case 953:
                if (!0 === S.test(e))
                    return 115 === (l = e.substring(e.indexOf(":") + 1)).charCodeAt(0) ? i(e.replace("stretch", "fill-available"), t, n, o).replace(":fill-available", ":stretch") : a.replace(l, "-webkit-" + l) + a.replace(l, "-moz-" + l.replace("fill-", "")) + a;
                break;
            case 962:
        ...
        function a(e, t, n, i, r, o, a, s, u, c) {
            for (var p, d = 0, f = t; d < A; ++d)
                switch (p = M[d].call(l, e, f, n, i, r, o, a, s, u, c)) {
                case void 0:
                case !1:
                case !0:
                case null:
        ...
        function l(e, n) {
            ...
            var p = function e(n, s, l, p, d) {
                for (var f, h, m, b, x, k = 0, C = 0, S = 0, E = 0, M = 0, D = 0, R = m = f = 0, F = 0, j = 0, I = 0, U = 0, z = l.length, W = z - 1, V = "", B = "", H = "", q = ""; F < z; ) {
                    if (h = l.charCodeAt(F),
                    F === W && 0 !== C + E + S + k && (0 !== C && (h = 47 === C ? 10 : 47),
                    E = S = k = 0,
                    z++,
                    W++),
                    0 === C + E + S + k) {
                        if (F === W && (0 < j && (V = V.replace(c, "")),
                        0 < V.trim().length)) {
                            switch (h) {
                            case 32:
                            case 9:
                        ...
                        case 123:
                            ...
                            switch (m = l.substring(U, F),
                            0 === f && (f = (V = V.replace(u, "").trim()).charCodeAt(0)),
                            f) {
                            case 64:
                                switch (0 < j && (V = V.replace(c, "")),
                                h = V.charCodeAt(1)) {
                                case 100:
                                case 109:
                                case 115:
                                ...
                                if (U = (m = e(s, j, m, h, d + 1)).length,
                                0 < A && (x = a(3, m, j = t(N, V, I), s, _, T, U, h, d, p),
                                V = j.join(""),
                        ...
                        case 125:
                        case 59:
                            if (1 < (U = (V = (0 < j ? V.replace(c, "") : V).trim()).length))
                                switch (0 === R && (f = V.charCodeAt(0),
                                45 === f || 96 < f && 123 > f) && (U = (V = V.replace(" ", ":")).length),
                                0 < A && void 0 !== (x = a(1, V, s, n, _, T, B.length, p, d, p)) && 0 === (U = (V = x.trim()).length) && (V = "\0\0"),
                                f = V.charCodeAt(0),
                                h = V.charCodeAt(1),
                                f) {
                                case 0:
                    ...
                    case 13:
                    case 10:
                        47 === C ? C = 0 : 0 === 1 + f && 107 !== p && 0 < V.length && (j = 1,
                        V += "\0"),
                        0 < A * L && a(0, V, s, n, _, T, B.length, p, d, p),
                        T = 1,
                        _++;
                        break;
                    case 59:
                        ...
                        case 47:
                            if (!(0 < E + k + S))
                                ...
                                case 0:
                                    ...
                                    break;
                                case 42:
                                    47 === h && 42 === M && U + 2 !== F && (33 === l.charCodeAt(U + 2) && (B += l.substring(U, F + 1)),
                                    b = "",
                                    C = 0)
                                }
                        }
                ...
                if (0 < (U = B.length)) {
                    if (j = s,
                    0 < A && void 0 !== (x = a(2, B, j, n, _, T, U, p, d, p)) && 0 === (B = x).length)
                        return q + B + H;
                    if (B = j.join(",") + "{" + B + "}",
                    0 != O * P) {
                        switch (2 !== O || r(B, 2) || (P = 0),
                        P) {
                        case 111:
            ...
            return 0 < A && void 0 !== (l = a(-2, p, s, s, _, T, p.length, 0, 0, 0)) && (p = l),
            P = 0,
            T = _ = 1,
            p
        }
    ...
    var d = function(e, t, n) {
        var i = e.key + "-" + t.name;
        if (!1 === n && void 0 === e.registered[i] && (e.registered[i] = t.styles),
    ...
    var f = function(e) {
        for (var t, n = e.length, i = n ^ n, r = 0; n >= 4; )
            t = 1540483477 * (65535 & (t = 255 & e.charCodeAt(r) | (255 & e.charCodeAt(++r)) << 8 | (255 & e.charCodeAt(++r)) << 16 | (255 & e.charCodeAt(++r)) << 24)) + ((1540483477 * (t >>> 16) & 65535) << 16),
            i = 1540483477 * (65535 & i) + ((1540483477 * (i >>> 16) & 65535) << 16) ^ (t = 1540483477 * (65535 & (t ^= t >>> 24)) + ((1540483477 * (t >>> 16) & 65535) << 16)),
            n -= 4,
            ++r;
        switch (n) {
        case 3:
            ...
            return function(e, t, n) {
                ...
                if (Array.isArray(n))
                    ...
                    for (var o in n) {
                        var a = n[o];
                        if ("object" != typeof a)
                            null != t && void 0 !== t[a] ? i += o + "{" + t[a] + "}" : i += y(o) + ":" + b(o, a) + ";";
    ...
    var C = function(e, t, n) {
        ...
        x = void 0;
        var o = e[0];
        null == o || void 0 === o.raw ? (i = !1,
        r += w(n, t, o, !1)) : r += o[0];
        for (var a = 1; a < e.length; a++)
            r += w(n, t, e[a], 46 === r.charCodeAt(r.length - 1)),
            i && (r += o[a]);
        k.lastIndex = 0;
        for (var s, l = ""; null !== (s = k.exec(r)); )
            l += "-" + s[1];
        return {
            name: f(r) + l,
            styles: r,
    ...
    function(e) {
      ...
      , N = function(e, t, n, r) {
        ...
        a.push(l),
        void 0 !== t.className && (s = p(e.registered, a, t.className));
        var u = C(a);
        d(e, u, "string" == typeof o);
        s += e.key + "-" + u.name;
        var c = {};
        for (var f in t)
            O.call(t, f) && "css" !== f && f !== P && (c[f] = t[f]);
        return c.ref = r,
        c.className = s,
        Object(i.createElement)(o, c)
    }
      , M = _(function(e, t, n) {
    ...
    var D = n(8)
      ...
      , J = function e(t, n) {
        ...
        return function() {
            ...
            if (void 0 !== r && h.push("label:" + r + ";"),
            null == f[0] || void 0 === f[0].raw)
                h.push.apply(h, f);
            else {
                h.push(f[0][0]);
                for (var m = f.length, v = 1; v < m; v++)
                    h.push(f[v], f[0][v])
            }
            var g = _(function(e, t, n) {
                return Object(i.createElement)(T.Consumer, null, function(r) {
                    ...
                    for (var x in e)
                        c && "as" === x || b(x) && (w[x] = e[x]);
                    return w.className = f,
                    w.ref = n || e.innerRef,
                    Object(i.createElement)(s, w)
                })
            });
            return g.displayName = void 0 !== r ? r : "Styled(" + ("string" == typeof l ? l : l.displayName || l.name || "Component") + ")",
            g.defaultProps = t.defaultProps,
            g.__emotion_real = g,
            g.__emotion_base = l,
            g.__emotion_styles = h,
            g.__emotion_forwardProp = o,
            ...
            g.withComponent = function(t, i) {
                return e(t, void 0 !== i ? K()({}, n || {}, i) : n).apply(void 0, h)
            }
            ,
            g
        }
      ...
      , pe = {
        ...
        franksinatra: {
            niceName: "Frank Sinatra"
        },
        bluegrass: {
            niceName: "Bluegrass"
        },
        tchaikovsky: {
            niceName: "Tchaikovsky"
        },
        schubert: {
            niceName: "Schubert"
        },
        ...
        michaelbuble: {
            niceName: "Michael Buble"
        },
        tvthemes: {
            niceName: "TV Themes"
        },
        tv: {
            niceName: "TV Themes (test)"
        },
        moviesoundtracks: {
            niceName: "Movie Soundtracks"
        },
        movie: {
            niceName: "Movie Soundtracks(test)"
        },

        rickymartin: {
            niceName: "Ricky Martin"
        },
        bollywood: {
            niceName: "Bollywood"
        },
        ...
        oscarpeterson: {
            niceName: "Oscar Peterson"
        },
        taylorswift: {
            niceName: "Taylor Swift"
        },
        beyonce: {
            niceName: "Beyonce"
        },
      ...
      , ve = function(e) {
        if (!e.genre)
            throw "Invalid genre.";
        if (!e.instrument)
            throw "Invalid instrument set.";
        var t = ae()({}, e);
        return t.encoding = t.encoding || "",
        t.generationLength = Object(re.i)(Object(re.e)(t.generationLength, he)),
        t.temperature = Object(re.e)(t.temperature, de),
        t.truncation = Object(re.i)(Object(re.e)(t.truncation, fe)),
        t
    }
      , ge = function() {
        function e(t) {
            ...
            this.toString = function() {
                return "Fragment:".concat(n.timeStart, "-").concat(n.timeEnd)
            }
            ,
      ...
      , we = function() {
        function e(t) {
            var n = this
              ...
              , a = void 0 === o ? [] : o;
            if (j()(this, e),
            this.getInstrumentFlags = function() {
                var e = new se.a;
                if ("" == n.encoding)
                    return se.b;
                var t = !0
                ...
                try {
                    ...
                    }, s = n.tracks[Symbol.iterator](); !(t = (o = s.next()).done); t = !0)
                        a()
                } catch (e) {
                    i = !0,
                    r = e
            ...
            this.onMediaCanPlayThrough = function(e) {
                n.isLoaded = !0,
                n.isLoading = !1,
                n.callbackOnLoad && n.callbackOnLoad(),
                n.media.removeEventListener("canplaythrough", n.onMediaCanPlayThrough, !1)
            }
            ,
            this.requestPlay = function(e) {
                ...
                if (t) {
                    ...
                    var i = 0;
                    e && e.fromTime && (i = e.fromTime),
                    i < .05 && (i = .05),
                    t.currentTime = i,
                    e && e.onStoppedPlaying && (n.onStoppedPlayingCallback = e.onStoppedPlaying),
                    e && e.onTimeUpdate && (n.callbackOnTimeUpdate = e.onTimeUpdate),
                    t.addEventListener("timeupdate", n.onTimeUpdate, !1),
                    t.addEventListener("ended", n.onPlaybackStopped, !1),
                    t.addEventListener("pause", n.onPlaybackStopped, !1),
                    e && (e.stopTime || 0 === e.stopTime) ? n.stopAtTime = e.stopTime : n.stopAtTime = null,
                    "safari/webkit" == re.d && t.addEventListener("canplaythrough", function() {
                        t.currentTime = i
                    }, !1),
                    t.play().then(function() {
                        ...
                        ke(t),
                        e && e.onStartedPlaying && e.onStartedPlaying()
                    }).catch(function(e) {
                        n.onStoppedPlayingCallback && n.onStoppedPlayingCallback(),
                        console.error(e)
                    })
                }
            }
            ...
            this.onTimeUpdate = function() {
                var e = n.media;
                if (e && (n.playbackTime = e.currentTime),
                n.callbackOnTimeUpdate && n.callbackOnTimeUpdate(),
                e && (n.stopAtTime || 0 === n.stopAtTime) && e.currentTime > n.stopAtTime)
                    try {
                        e.pause()
                    } catch (e) {}
            }
            ...
            this.onPlaybackStopped = function() {
                n.isPlaying = !1,
                n.playbackTime = 0,
                n.callbackOnTimeUpdate = null,
                n.media && n.onStoppedPlayingCallback && n.onStoppedPlayingCallback()
            }
            ,
            this.requestDownload = function(e) {
                if (re.f)
                    try {
                        ...
                        e || (e = "MuseNet2.".concat(n.audioFormat)),
                        e.endsWith(".".concat(n.audioFormat)) || (e += ".".concat(n.audioFormat)),
                        Object(ye.saveAs)(i, e)
                    } catch (e) {
            ...
            ,
            this.encoding = "",
            this.humanReadableEncoding = "",
            this.totalTime = 0,
            this.audioFile = null,
            this.audioFormat = "mp3",
            this.audioMimeType = "audio/mp3",
            this.tracks = [],
            this.fragments = a || [],
            this.bpm = 100,
            this.isLoading = !1,
            ...
            this.isPlaying = !1,
            this.playbackTime = 0,
            this.callbackOnTimeUpdate = null,
            this.parent = null,
            this.media = null,
            this.audioSrcNode = null,
            r && (this.encoding = r.encoding,
            this.humanReadableEncoding = r.humanReadableEncoding,
            this.totalTime = r.totalTime,
            r.oggFile && (re.a.warn("Received audio data in oggFile param."),
            this.audioFile = r.oggFile,
            this.audioFormat = "ogg",
            this.audioMimeType = "audio/ogg"),
            r.audioFormat && (re.a.log("Received audio format param: " + r.audioFormat),
            this.audioFile = r.audioFile,
            "mp3" == r.audioFormat ? (this.audioFormat = "mp3",
            this.audioMimeType = "audio/mp3",
            re.a.log("Response format: mp3")) : "ogg" == r.audioFormat ? (console.log("Received ogg file in completion response."),
            this.audioFormat = "ogg",
            this.audioMimeType = "audio/ogg",
            re.a.log("Response format: ogg")) : console.error("Unexpected audioFormat in response: " + r.audioFormat)),
            this.tracks = r.tracks,
            0 == this.fragments.length && this.fragments.push(new ge({
                timeStart: 0,
                timeEnd: r.totalTime
            })),
        ...
        return U()(e, [{
            ...
            value: function(e, t, n) {
                ...
                try {
                    ...
                    this.mediaSrc = "data:".concat(this.audioMimeType, ";base64,").concat(i),
                    this.media = new Audio(this.mediaSrc),
                    this.parent = t,
                    this.parent.appendChild(this.media),
                    this.audioSrcNode = e.createMediaElementSource(this.media),
                    this.audioSrcNode.connect(e.destination),
                    this.media.addEventListener("canplaythrough", this.onMediaCanPlayThrough, !1),
                    this.callbackOnLoad = n ? n.onSuccess : null
                } catch (e) {
                    this.isLoading = !1,
            ...
            value: function() {
                ...
                return null == e || 0 == e.length ? null : (e.startsWith("b'") && (e = e.substring(2, e.length - 1)),
                e)
            }
        }, {
            key: "unload",
            value: function() {
                this.parent.removeChild(this.media),
                this.parent = null,
                this.media.src = null,
                this.media = null,
      ...
      , Pe = {
        ...
        CUSTOM_MIDI: {
            niceName: "Custom (MIDI Upload)"
        },
        rondo_a_la_turca: {
            niceName: "Mozart’s Rondo alla Turca"
        },
        Beethoven_5th: {
            niceName: "Beethoven’s Symphony No. 5"
        },
        PokerFace: {
            niceName: "Lady Gaga’s Poker Face"
        },
        fur_elise: {
            niceName: "Beethoven’s Für Elise"
        },
        SomeoneLikeYou: {
            niceName: "Adele’s Someone Like You"
        },
        CryMeARiver: {
            niceName: "Justin Timberlake’s Cry Me A River"
        },
        despacito: {
            niceName: "Luis Fonsi’s Despacito"
        },
        frozen: {
            niceName: "Frozen’s Let It Go"
        },
        Godfather: {
                ...
                var t = ie()(te.a.mark(function t(n) {
                    ...
                    return te.a.wrap(function(t) {
                        for (; ; )
                            ...
                            case 0:
                                if (i = n.setCompletionPending,
                                r = n.famousStart,
                                o = n.inputElementForCustomUpload,
                                a = n.callbacks,
                                s = void 0 === a ? {
                                    onSuccess: function(e) {},
                                    onError: function(e) {}
                                } : a,
                                null === r || _e.includes(r)) {
                                    t.next = 4;
                                    break
                                }
                                return s && s.onError && s.onError("Unsupported famous start: ".concat(r)),
                                t.abrupt("return");
                            case 4:
                                if (l = !1,
                                "CUSTOM_MIDI" == r && (o ? (l = !0,
                                ...
                                o.click()) : (re.a.log("(No inputElementForCustomUpload provided, can't upload custom MIDI file."),
                                r = null)),
                                null !== r) {
                                    t.next = 11;
                                    break
                            ...
                            case 11:
                                ...
                                return t.prev = 12,
                                p = re.a.useMockData ? "`./mock/starts_json/${famousStart}.json`" : "https://cdn.openai.com/musenet/starts/".concat(r, "_mp3.json"),
                                t.next = 16,
                                fetch(p);
                            case 16:
                                return t.next = 18,
                            ...
                            case 18:
                                ...
                                s && s.onSuccess && s.onSuccess(d),
                                t.next = 26;
                                break;
                            case 23:
                                t.prev = 23,
                                t.t0 = t.catch(12),
                                s && s.onError && s.onError(t.t0);
                            case 26:
                            case "end":
                                return t.stop()
                            }
                    ...
                    return te.a.wrap(function(e) {
                        for (; ; )
                            ...
                            case 6:
                                ...
                                return o("Unexpected extension in " + n.name),
                                e.abrupt("return");
                            case 9:
                                return e.prev = 9,
                                e.next = 12,
                                Object(re.b)(n);
                            case 12:
                                return (s = e.sent).startsWith("data:audio/mid;base64,") ? s = s.substr("data:audio/mid;base64,".length) : s.startsWith("data:audio/midi;base64,") && (s = s.substr("data:audio/midi;base64,".length)),
                                s = "b'".concat(s, "'"),
                                l = JSON.stringify({
                                    midi: s,
                                    audioFormat: "mp3"
                                }),
                                console.log("Requesting custom midi: " + l),
                                e.next = 19,
                            ...
                            case 23:
                                ...
                                u.json();
                            case 25:
                                if ((c = e.sent).completions) {
                                    e.next = 29;
                                    break
                                }
                                return o("Midi response JSON did not contain 'completions'."),
                                e.abrupt("return");
                            case 29:
                                if (c.completions[0]) {
                                    e.next = 32;
                                ...
                                return o("Midi response JSON did not contain completions[0]."),
                                e.abrupt("return");
                            case 32:
                                p = new we({
                                    completion: c.completions[0]
                    ...
                    return te.a.wrap(function(e) {
                        for (; ; )
                            ...
                            case 0:
                                if (n = t.request,
                                i = t.composition,
                                r = t.getPrecachedCompletion,
                                o = t.precachedFamousStart,
                                a = t.completeFromTime,
                                s = t.onSuccess,
                                l = t.onError,
                                e.prev = 1,
                                n.encoding = i.encoding,
                                n = ve(n),
                                !re.a.useMockData) {
                                    e.next = 12;
                                    break
                                ...
                                return e.next = 7,
                                fetch("./mock/mock_completion.json");
                            case 7:
                                return e.next = 9,
                                e.sent.json();
                            case 9:
                                ...
                                break;
                            case 12:
                                if (n.completeFromTime = null != a ? a : void 0,
                                n.generationLength = parseInt(document.getElementsByClassName("rc-slider-handle")[0].ariaValueNow),
                                c = JSON.stringify(n),
                                re.a.log(c),
                                !r) {
                                    e.next = 40;
                                ...
                                return o || (o = "scratch"),
                                p = "".concat(n.genre, "_").concat(o),
                                d = "https://cdn.openai.com/musenet/samples/".concat(p, ".json"),
                                f = "https://cdn.openai.com/musenet/samples/".concat(p, "_mp3.json"),
                                e.prev = 20,
                                re.a.log("Retrieving precached completion at : " + f + ".json"),
                                e.next = 24,
                                fetch(f);
                            case 24:
                                return e.next = 26,
                            ...
                            case 29:
                                return e.prev = 29,
                                e.t0 = e.catch(20),
                                console.log("Mp3 precached fetch failed, tried ".concat(f, ". Falling back to ogg via: ").concat(d)),
                                re.a.log("Retrieving ogg fallback precached completion at: " + d + ".json"),
                                e.next = 35,
                                fetch(d);
                            case 35:
                                return e.next = 37,
                            ...
                            case 44:
                                u = e.sent;
                            case 45:
                                u.error ? l && l(u) : re.a.log(u),
                                h = [],
                                m = null == a ? i.fragments : i.fragments.filter(function(e) {
                                    return e.timeEnd <= a
                                }),
                    ...
                    return te.a.wrap(function(e) {
                        for (; ; )
                            ...
                            case 0:
                                ...
                                console.log("Requesting download: " + a),
                                e.next = 6,
                                fetch("https://musenet.openai.com/audio", {
                                    method: "POST",
                                    mode: "cors",
                                    headers: {
                                        "Content-Type": "application/json"
      ...
      , Me = function(e, t) {
        var n, i = e.target.files, r = function(e) {
            t.onError && t.onError(e)
        };
        if (i && i[0]) {
            var o = i[0];
            Ae(o.name) ? (re.a.log("file name ".concat(o.name, " ends with midi or mid")),
            n = o,
            t.onMidiFile && t.onMidiFile(n)) : r("file name ".concat(o.name, " does not end with midi or mid"))
        } else
            i ? i[0] ? (r("Unknown issue"),
            console.table(i)) : r("No files[0] object available.") : r("No files in event.")
    }
      , Ae = function(e) {
      ...
      , je = function(e) {
        function t(e) {
            var n;
            return j()(this, t),
            (n = W()(this, B()(t).call(this, e))).state = {
                relMousePos: null
            },
            ...
            ,
            n.divRef = r.a.createRef(),
            n.canvasRef = r.a.createRef(),
            n
        }
        return q()(t, e),
        U()(t, [{
            ...
            value: function() {
                ...
                for (var r = this.props.composition.tracks, o = 0, a = "hsl(0, 80%, 80%)", s = 0; s < r.length; s++) {
                    ...
                    for (var u = l.notes, c = null, p = 0, d = 0, f = 0, h = 0, m = 0, v = 0; v < u.length; v++)
                        (c = u[v]).time_on < this.props.fragment.timeStart || c.time_on > this.props.fragment.timeEnd || (p = Object(re.j)(c.pitch, 0, 100, 0, 100),
                        d = t * (c.time_on - e.timeStart) + o,
                        f = Le - Re * p + o,
                        h = Math.max(c.duration, .1),
                        m = Math.max(t * h, 1),
                        Object(re.j)(p, 0, 100, 0, 360),
                        i.fillStyle = a,
                        i.fillRect(d, f, m, Fe))
                }
            }
    ...
    var Xe = function(e) {
        var t, n = function(t) {
            function n() {
                ...
                for (var o = arguments.length, a = new Array(o), s = 0; s < o; s++)
                    a[s] = arguments[s];
                return W()(r, (i = r = W()(this, (t = B()(n)).call.apply(t, [this].concat(a))),
        ...
        return n.displayName = "WithSpinner(".concat((t = e).displayName || t.name || "Component", ")"),
        n
    }(function(e) {
        return A("div", {
            className: e.className,
      ...
      , Ye = function(e) {
        function t(e) {
            ...
            n.setFlickityRef = function(e) {
                n.flkty = e,
                n.flkty.on("dragMove", n.onFlktyDragMove),
                n.flkty.on("dragEnd", n.onFlktyDragEnd)
            }
            ,
            ...
            n.updateCompositionAudio = function() {
                var e = n.getActiveComposition();
                if (e && (e.isReadyToLoad && n.props.audioContext && n.divRef.current && e.load(n.props.audioContext, n.divRef.current),
                e.media))
                    return;
            ...
            n.updatePlayhead = function() {
                ...
                if (n.playheadRef.current)
                    if (e && e.isPlaying) {
                        ...
                        var i = e.totalTime;
                        e.playbackTime < i ? n.playheadRef.current.style.visibility = "visible" : (n.playheadRef.current.style.left = "0px",
                        n.playheadRef.current.style.visibility = "hidden")
                    } else
                        n.playheadRef.current.style.left = "0px",
                        n.playheadRef.current.style.visibility = "hidden"
            }
            ,
            n.unloadCompositionAudio = function() {
                ...
                var t = !0
                  ...
                  , r = void 0;
                try {
                    for (var o, a = n.props.compositionOptions[Symbol.iterator](); !(t = (o = a.next()).done); t = !0) {
                        o.value.unload()
                    }
                } catch (e) {
                    i = !0,
    ...
    n(35))
      ...
      , Je = function(e) {
        var t, n = e.famousStartOptions.map(function(e) {
            return {
                value: e,
                label: (t = Pe[e].niceName,
                "scratch" == t ? "none (start from scratch)" : t),
                className: "mcc-dropdown-item small-caps"
            };
            var t
        }), i = {
            value: e.famousStart,
            label: (t = Pe[e.famousStart].niceName,
            e.advanced && "scratch" == t ? "none" : t),
            ...
            return A("button", {
                ...
                onClick: function() {
                    if (e.onChangeInstrumentFlags) {
                        ...
                        n[t] = !e.instrumentFlags[t],
                        e.onChangeInstrumentFlags(n)
                    }
                }
            }, t)
        }))
      ...
      , Nt = function(e) {
        var t = e.prefixCls
          ...
          , m = function(e, t, n, i, r, o) {
            ...
            return a
        }(0, i, o, a, p, c).map(function(e) {
            var i, o = Math.abs(e - p) / h * 100 + "%", a = !s && e === u || s && e <= u && e >= l, c = n ? ot()({
                bottom: o
            }, d) : ot()({
                left: o
            }, d);
    ...
    var Mt = Nt
      , At = function(e) {
        var t = e.className
          ...
          , p = Object.keys(i)
          , d = l - u
          , f = p.map(parseFloat).sort(function(e, t) {
            return e - t
        }).map(function(e) {
            var l, p = i[e], f = "object" == typeof p && !r.a.isValidElement(p), h = f ? p.label : p;
            if (!h && 0 !== h)
                return null;
            var m = !o && e === a || o && e <= a && e >= s
              , v = Ot()((l = {},
            kt()(l, t + "-text", !0),
            kt()(l, t + "-text-active", m),
            l))
              , g = n ? {
                marginBottom: "-50%",
                bottom: (e - u) / d * 100 + "%"
      ...
      , Lt = function(e) {
        function t() {
            ...
            for (var o = arguments.length, a = Array(o), s = 0; s < o; s++)
                a[s] = arguments[s];
            return n = i = pt()(this, (e = t.__proto__ || Object.getPrototypeOf(t)).call.apply(e, [this].concat(a))),
            i.state = {
                clickFocused: !1
            },
        ...
        ut()(t, [{
            ...
            value: function() {
                var e = this.props
                  ...
                  , h = ot()({}, o, f)
                  , m = c || 0;
                return (a || null === c) && (m = null),
                r.a.createElement("div", ot()({
    ...
    var Ft = n(36)
      ...
      , It = {
        ...
        isTextModifyingKeyEvent: function(e) {
            var t = e.keyCode;
            if (e.altKey && !e.ctrlKey || e.metaKey || t >= It.F1 && t <= It.F12)
                return !1;
            switch (t) {
            case It.ALT:
            case It.CAPS_LOCK:
        ...
        isCharacterKey: function(e) {
            if (e >= It.ZERO && e <= It.NINE)
                return !0;
            if (e >= It.NUM_ZERO && e <= It.NUM_MULTIPLY)
                return !0;
            if (e >= It.A && e <= It.Z)
                return !0;
    ...
    function $t(e, t, n) {
        var i = {
          ...
          , r = i[e](Object.keys(n.marks).indexOf(JSON.stringify(t)), 1)
          , o = Object.keys(n.marks)[r];
        return n.step ? i[e](t, n.step) : Object.keys(n.marks).length && n.marks[o] ? n.marks[o] : t
    }
    function Qt(e) {
        switch (e.keyCode) {
        case Ut.UP:
    ...
    function Jt(e) {
        ...
        return n = t = function(e) {
            function t(e) {
                st()(this, t);
                var n = pt()(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e));
            ...
            ut()(t, [{
                ...
                key: "componentWillUnmount",
                value: function() {
                    St()(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "componentWillUnmount", this) && St()(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "componentWillUnmount", this).call(this),
                ...
                value: function() {
                    this.onTouchMoveListener = _t(this.document, "touchmove", this.onTouchMove),
                    this.onTouchUpListener = _t(this.document, "touchend", this.onEnd)
                }
            }, {
                key: "addDocumentMouseEvents",
                value: function() {
                    this.onMouseMoveListener = _t(this.document, "mousemove", this.onMouseMove),
                    this.onMouseUpListener = _t(this.document, "mouseup", this.onEnd)
                }
            }, {
                ...
                key: "render",
                value: function() {
                    var e, n = this.props, i = n.prefixCls, o = n.className, a = n.marks, s = n.dots, l = n.step, u = n.included, c = n.disabled, p = n.vertical, d = n.min, f = n.max, h = n.children, m = n.maximumTrackStyle, v = n.style, g = n.railStyle, y = n.dotStyle, b = n.activeDotStyle, w = St()(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "render", this).call(this), x = w.tracks, k = w.handles, C = Ot()(i, (e = {},
                    kt()(e, i + "-with-marks", Object.keys(a).length),
                    kt()(e, i + "-disabled", c),
                    kt()(e, i + "-vertical", p),
                    kt()(e, o, o),
                    e));
        ...
        t.defaultProps = ot()({}, e.defaultProps, {
            ...
            handle: function(e) {
                ...
                null === n.value ? null : r.a.createElement(Rt, ot()({}, n, {
                    key: t
                }))
            },
            onBeforeChange: Zt,
    ...
    var en = function(e) {
        ...
        ut()(t, [{
            ...
            value: function(e) {
                ...
                i !== n && (this.prevMovedHandleIndex = 0,
                this.onChange({
                    value: i
                }))
            }
      ...
      , on = function(e) {
        function t(e) {
            ...
            var i = e.count
              , r = e.min
              , o = e.max
              , a = Array.apply(void 0, jt()(Array(i + 1))).map(function() {
                return r
            })
              , s = "defaultValue"in e ? e.defaultValue : a
              , l = (void 0 !== e.value ? e.value : s).map(function(e, t) {
        ...
        ut()(t, [{
            ...
            value: function(e) {
                ...
                if (this.prevMovedHandleIndex = this.getBoundNeedMoving(r, o),
                this.setState({
            ...
            key: "getClosestBound",
            value: function(e) {
                for (var t = this.state.bounds, n = 0, i = 1; i < t.length - 1; ++i)
                    e > t[i] && (n = i);
            ...
            value: function(e, t) {
                var n = this.state
                  ...
                  , o = t
                  , a = i[t + 1] === i[t];
                return a && i[r] === i[t] && (o = r),
                a && e !== i[t + 1] && (o = e < i[t + 1] ? t : t + 1),
                o
            }
        }, {
            key: "getLowerBound",
            ...
            value: function(e, t, n) {
                ...
                var o = t + n
                  ...
                  , l = n * (e[o] - a);
                return !!this.pushHandle(e, o, n, s - l) && (e[t] = a,
                !0)
            }
        }, {
            key: "trimAlignValue",
    ...
    var ln = function(e) {
        function t() {
            ...
            for (var o = arguments.length, a = Array(o), s = 0; s < o; s++)
                a[s] = arguments[s];
            return n = i = pt()(this, (e = t.__proto__ || Object.getPrototypeOf(t)).call.apply(e, [this].concat(a))),
            i.removeContainer = function() {
                i.container && (L.a.unmountComponentAtNode(i.container),
            ...
            i.renderComponent = function(e, t) {
                var n = i.props
                  ...
                  , s = n.getContainer
                  , l = n.parent;
                (r || l._component || a) && (i.container || (i.container = s()),
                L.a.unstable_renderSubtreeIntoContainer(l, o(e), i.container, function() {
                    t && t.call(this)
                }))
            }
            ,
    ...
    var un = ln
      , cn = function(e) {
        function t() {
            return st()(this, t),
            pt()(this, (t.__proto__ || Object.getPrototypeOf(t)).apply(this, arguments))
        }
        return ft()(t, e),
        ut()(t, [{
            key: "componentDidMount",
    ...
    function Tn(e, t, n) {
        var i = n;
        if ("object" !== (void 0 === t ? "undefined" : Cn(t)))
            return void 0 !== i ? ("number" == typeof i && (i += "px"),
            void (e.style[t] = i)) : Sn(e, t);
        for (var r in t)
            t.hasOwnProperty(r) && Tn(e, r, t[r])
    }
    function _n(e, t) {
    ...
    function Nn(e) {
        var t = function(e) {
            var t, n = void 0, i = void 0, r = e.ownerDocument, o = r.body, a = r && r.documentElement;
    ...
    function Wn(e, t, n) {
        ...
        "top" !== a && (r = 999);
        var u, c = "", p = Nn(e);
        ("left"in t || "top"in t) && (c = (u = e).style.transitionProperty || u.style[gn()] || "",
        bn(e, "none")),
        "left"in t && (e.style[s] = "",
        e.style[o] = i + "px"),
        "top"in t && (e.style[l] = "",
    ...
    function Vn(e, t) {
        ...
        "left"in t && (r.x = i.x + t.left - n.left),
        "top"in t && (r.y = i.y + t.top - n.top),
        function(e, t) {
            ...
            if (i && "none" !== i) {
                var r = void 0
                  , o = i.match(xn);
                o ? ((r = (o = o[1]).split(",").map(function(e) {
                    return parseFloat(e, 10)
                }))[4] = t.x,
                r[5] = t.y,
                wn(e, "matrix(" + r.join(",") + ")")) : ((r = i.match(kn)[1].split(",").map(function(e) {
                    return parseFloat(e, 10)
                }))[12] = t.x,
                r[13] = t.y,
                wn(e, "matrix3d(" + r.join(",") + ")"))
            } else
                wn(e, "translateX(" + t.x + "px) translateY(" + t.y + "px) translateZ(0)")
        }(e, r)
    }
    function Bn(e, t) {
        for (var n = 0; n < e.length; n++)
    ...
    "undefined" != typeof window && (Sn = window.getComputedStyle ? function(e, t, n) {
        var i = n
          , r = ""
          , o = An(e);
        return (i = i || o.defaultView.getComputedStyle(e, null)) && (r = i.getPropertyValue(t) || i[t]),
        r
    }
    : function(e, t) {
        var n = e[Rn] && e[Rn][t];
    ...
    function Qn(e, t, n) {
        var i = n;
        if (Mn(e))
            return "width" === t ? $n.viewportWidth(e) : $n.viewportHeight(e);
        if (9 === e.nodeType)
            return "width" === t ? $n.docWidth(e) : $n.docHeight(e);
        ...
        Hn(e))
          , s = 0;
        (null == o || o <= 0) && (o = void 0,
        (null == (s = Sn(e, t)) || Number(s) < 0) && (s = e.style[t] || 0),
        s = parseFloat(s) || 0),
        void 0 === i && (i = a ? Yn : Xn);
        var l = void 0 !== o || a
          , u = o || s;
    ...
    Bn(["width", "height"], function(e) {
        ...
        $n[e] = function(t, i) {
            ...
            if (t) {
                Sn(t);
                return Hn(t) && (r += Kn(t, ["padding", "border"], n)),
                Tn(t, e, r)
            }
        }
    });
    ...
    var ri = function(e) {
        ...
        var l = null;
        ni.isWindow(e) || 9 === e.nodeType || (l = e.style.position,
        "absolute" === ni.css(e, "position") && (e.style.position = "fixed"));
        ...
        if ("hidden" === m.overflowX && (f = r.innerWidth),
    ...
    var ai = function(e) {
        ...
        if (ni.isWindow(e) || 9 === e.nodeType) {
            ...
            n = ni.viewportWidth(r),
            i = ni.viewportHeight(r)
        } else
            t = ni.offset(e),
            n = ni.outerWidth(e),
            i = ni.outerHeight(e);
    ...
    var mi = function(e, t, n, i) {
        ...
        if (p && (s.adjustX || s.adjustY) && i) {
            ...
            (u.adjustX || u.adjustY) && (h = oi(f, d, p, u))
        }
        return h.width !== d.width && ni.css(l, "width", ni.width(l) + h.width - d.width),
        h.height !== d.height && ni.css(l, "height", ni.height(l) + h.height - d.height),
        ni.offset(l, {
            left: h.left,
            top: h.top
        }, {
    ...
    vi.__getOffsetParent = ii,
    vi.__getVisibleRectForElement = ri;
    var gi = vi
    ...
    var Si = function(e) {
        ...
        ut()(t, [{
            ...
            value: function() {
                ...
                this.resizeHandler = _t(window, "resize", this.bufferMonitor))
            }
        }, {
    ...
    "undefined" != typeof window && "undefined" != typeof document && function() {
        ...
        "AnimationEvent"in window || (delete Mi.animationstart.animation,
        delete Ai.animationend.animation),
        "TransitionEvent"in window || (delete Mi.transitionstart.transition,
        delete Ai.transitionend.transition),
        t(Mi, Di),
        t(Ai, Li)
    }();
    var ji = {
    ...
    var Xi = function(e, t, n) {
        ...
        e.rcEndListener = function(t) {
            ...
            u.remove(r),
            u.remove(o),
            ji.removeEndEventListener(e, e.rcEndListener),
            e.rcEndListener = null,
            a && a())
        }
        ,
        ji.addEndEventListener(e, e.rcEndListener),
        s && s(),
        u.add(r),
    ...
    var tr = function(e) {
        ...
        ut()(t, [{
            ...
            value: function(e) {
                ...
                var o, a, s, l, u = i.showProp, c = this.currentlyAnimatingKeys, p = i.exclusive ? Ti(Ji(i)) : this.state.children, d = [];
                ...
                p.forEach(function(e) {
                    e && _i(o, e.key) ? l.length && (s[e.key] = l,
                    l = []) : l.push(e)
                }),
                o.forEach(function(e) {
                    e && Object.prototype.hasOwnProperty.call(s, e.key) && (a = a.concat(s[e.key])),
                    a.push(e)
                }),
                d = a = a.concat(l)),
                this.setState({
                ...
                n.forEach(function(e) {
                    ...
                    if (!e || !c[n]) {
                        ...
                        if (u) {
                            var r = e.props[u];
                            if (i)
                                !Pi(p, n, u) && r && t.keysToEnter.push(n);
                            else
                ...
                p.forEach(function(e) {
                    ...
                    if (!e || !c[i]) {
                        ...
                        if (u) {
                            var o = e.props[u];
                            if (r)
                                !Pi(n, i, u) && o && t.keysToLeave.push(i);
                            else
                                o && t.keysToLeave.push(i)
                        } else
    ...
    var nr = function() {
        ...
        this.handleDoneAdding = function(t, n) {
            ...
            !i.exclusive || i === e.nextProps) {
                var r = Ti(Ji(i));
                e.isValidChildByKey(r, t) ? "appear" === n ? Yi.allowAppearCallback(i) && (i.onAppear(t),
                i.onEnd(t, !0)) : Yi.allowEnterCallback(i) && (i.onEnter(t),
        ...
        this.handleDoneLeaving = function(t) {
            ...
            !n.exclusive || n === e.nextProps) {
                ...
                if (e.isValidChildByKey(s, t))
                    ...
                    var l = function() {
                        Yi.allowLeaveCallback(n) && (n.onLeave(t),
                        n.onEnd(t, !1))
                    };
                    i = e.state.children,
                    r = s,
      ...
      , rr = function(e) {
        function t() {
            return st()(this, t),
            pt()(this, e.apply(this, arguments))
        }
        return ft()(t, e),
        ...
        t.prototype.render = function() {
            ...
            return t || r.a.Children.count(i.children) > 1 ? (!n && t && (i.className += " " + t),
            r.a.createElement("div", i)) : r.a.Children.only(i.children)
        }
        ,
        t
    }(i.Component);
    ...
    var sr = ar
      , lr = function(e) {
        function t(n) {
            ...
            i.savePopupRef = fn.bind(i, "popupInstance"),
            i.saveAlignRef = fn.bind(i, "alignInstance"),
            i
        }
        return ft()(t, e),
        ...
        t.prototype.getPopupElement = function() {
            ...
            var k = {};
            h && (-1 !== h.indexOf("height") ? k.height = o : -1 !== h.indexOf("minHeight") && (k.minHeight = o),
            -1 !== h.indexOf("width") ? k.width = a : -1 !== h.indexOf("minWidth") && (k.minWidth = a),
            i || (k.visibility = "hidden",
            setTimeout(function() {
      ...
      , mr = function(e) {
        ...
        t.prototype.componentDidUpdate = function(e, t) {
            ...
            i.popupVisible) {
                ...
                this.clickOutsideHandler = _t(r, "mousedown", this.onDocumentClick)),
                this.touchOutsideHandler || (r = r || n.getDocument(),
                this.touchOutsideHandler = _t(r, "touchstart", this.onDocumentClick)),
                !this.contextMenuOutsideHandler1 && this.isContextMenuToShow() && (r = r || n.getDocument(),
                this.contextMenuOutsideHandler1 = _t(r, "scroll", this.onContextMenuClose)),
                void (!this.contextMenuOutsideHandler2 && this.isContextMenuToShow() && (this.contextMenuOutsideHandler2 = _t(window, "blur", this.onContextMenuClose)))
            }
        ...
        t.prototype.render = function() {
            ...
            a && (u.onMouseMove = this.onMouseMove)) : u.onMouseEnter = this.createTwoChains("onMouseEnter"),
    ...
    mr.propTypes = {
        ...
        popup: mt.a.oneOfType([mt.a.node, mt.a.func]).isRequired,
    ...
    var vr = function() {
        ...
        this.getPopupClassNameFromAlign = function(t) {
            ...
            return r && o && n.push(function(e, t, n, i) {
                var r = n.points;
                for (var o in e)
                    if (e.hasOwnProperty(o) && dn(e[o].points, r, i))
        ...
        this.getContainer = function() {
            ...
            n.style.left = "0",
            n.style.width = "100%",
            (t.getPopupContainer ? t.getPopupContainer(Object(D.findDOMNode)(e)) : t.getDocument().body).appendChild(n),
            n
        }
        ,
    ...
    xr.propTypes = {
        prefixCls: mt.a.string,
        overlay: mt.a.oneOfType([mt.a.node, mt.a.func]).isRequired,
        id: mt.a.string,
        trigger: mt.a.any
    };
    var kr = xr
      , Cr = function(e) {
        function t() {
            ...
            for (var a = arguments.length, s = Array(a), l = 0; l < a; l++)
                s[l] = arguments[l];
            return n = i = pt()(this, e.call.apply(e, [this].concat(s))),
            i.getPopupElement = function() {
                var e = i.props
                  , t = e.arrowContent
                  , n = e.overlay
                  , o = e.prefixCls
        ...
        t.prototype.render = function() {
            var e = this.props
              ...
              , b = ot()({}, y);
            return "visible"in this.props && (b.popupVisible = this.props.visible),
            r.a.createElement(gr, ot()({
                popupClassName: t,
    ...
    tn.Range = an,
    tn.Handle = Rt,
    tn.createSliderWithTooltip = function(e) {
        var t, n;
        return n = t = function(t) {
            function n(e) {
                st()(this, n);
                var t = pt()(this, (n.__proto__ || Object.getPrototypeOf(n)).call(this, e));
                ...
                t.handleWithTooltip = function(e) {
                    var n = e.value
                      ...
                      , x = void 0;
                    return x = Array.isArray(p) ? p[o] || p[0] : p,
                    r.a.createElement(Sr, ot()({}, w, {
                        prefixCls: f,
                        overlay: m,
                        placement: g,
    ...
    function(e) {
        function t() {
            ...
            for (var o = arguments.length, a = new Array(o), s = 0; s < o; s++)
                a[s] = arguments[s];
            return W()(i, (n = i = W()(this, (e = B()(t)).call.apply(e, [this].concat(a))),
            i.render = function() {
                return A("div", {
      ...
      , Ar = function(e) {
        function t(e) {
            ...
            n.changeFamousStart = function(e) {
                if (Object(re.g)(),
                n.state.isCompletionPending)
                    re.a.warn("Completion is pending! (Requested new start)");
                else {
                    var t = n.activeComposition;
                    t && t.requestStop(),
                    "CUSTOM_MIDI" != e && n.setState({
                    ...
                    Oe.requestFamousStart({
                        ...
                        callbacks: {
                            onSuccess: function(t) {
                                ...
                                n.state.advanced ? null != e && (i = t.getInstrumentFlags()) : i = se.b,
            ...
            n.requestCompletion = function(e) {
                if (Object(re.g)(),
                n.isRequestAllowed || null != e)
                    if (n.state.isCompletionPending)
                        re.a.warn("Completion is pending!");
                    else {
                        ...
                        n.setState({
                            ...
                            Te.includes(i) ? (console.error("Unexpected advanced precache start: " + i),
                            n.setState({
                                isCompletionPending: !1
            ...
            n.onAudioStartedPlaying = function() {
                ...
                n.compViewRef.current && n.compViewRef.current.onAudioStartedPlaying()
            }
            ,
            n.onAudioTimeUpdate = function() {
            ...
            n.onFragmentClicked = function(e, t) {
                ...
                if (i.isLoaded) {
                    ...
                    try {
                        ...
                        o = .01 * parseFloat(/translate[X]*[3d]*\(*([-\d.]+)%/g.exec(a.getAttribute("style"))[1]) * a.offsetWidth,
                        o *= 1 / De(i) * -1
                    } catch (e) {
            ...
            n.requestDownload = function(e) {
                ...
                if (n.state.request.genre) {
                    ...
                    i = o && null != n.state.famousStart ? "MuseNet improvises ".concat(r || n.state.request.genre, " from ").concat(o, ".").concat(e) : "MuseNet improvises ".concat(r || n.state.request.genre)
                }
                t.audioFormat == e ? (t.requestDownload(i),
                n.setState({
                    isRequestingDownload: !1
                })) : n.setState({
                ...
                try {
                    gtag("event", "Download MuseNet composition", {
                        event_category: "Visualizations",
                        event_label: e
                    })
                } catch (e) {}
            ...
            n.toggleAdvanced = function() {
                n.setState(function(e) {
                    ...
                    n.state.advanced || (ue.includes(n.state.request.genre) && n.changeGenre(le[0]),
                    Te.includes(n.state.famousStart) && n.changeFamousStart(Se[0]))
                })
            }
            ,
            ...
            n.moveToCompletion = function(e) {
                ...
                document.querySelectorAll(".mcc-option-switcher").forEach(function(e) {
            ...
            n.setCompletionIndex = function(e) {
                n.setState(function(t) {
                    if (t.compositionOptions && t.compositionOptions.length > 0) {
                        if (null == t.activeCompositionIndex)
                            return {
                                activeCompositionIndex: 0
                            };
            ...
            ,
            n.compViewRef = r.a.createRef(),
            n.customMidiInputRef = r.a.createRef(),
            n
        }
        return q()(t, e),
        U()(t, [{
            ...
            value: function() {
                ...
                console.log(this)
                return !this.state.advanced && Te.includes(i) && (i = Se[0]),
                A(Mr, {
                ...
                }, A("span", null, "Compose in the style of "), A(tt, {
                    genre: n,
                    genreOptions: le,
                ...
                }), A("span", null, "starting ", i ? "with" : "from", " "), A(Je, {
                    famousStart: i,
                    ...
                    label: this.state.advanced ? "Hide Advanced Settings" : "Show Advanced Settings"
                }))), A(Ye, {
                ...
                }, "stopcircle"), "Stop playback") : A(r.a.Fragment, null, A("span", {
                    className: "icon mr-0.25",
                    style: {
                        fontSize: "4em"
                    }
                }, "playcircle"), "Play from start"))), A("div", {
                ...
                }, "Reset")))))))) : this.state.advanced ? A("div", {
                    className: "pt-0.5 mb-1.5 small-copy",
                    style: {
                        opacity: .8
                    }
                }, "Generating takes up to a minute") : A("div", {
                    className: "mt-2"
                })))), A("input", {
                    type: "file",
                    style: {
    ...
    if (null === Lr && (console.warn("No container #demo was found."),
